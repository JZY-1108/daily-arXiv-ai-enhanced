...
<details>
  <summary>Details</summary>
Motivation: To investigate how unbalanced training data affects scoring biases and disparities for English Language Learners (ELLs) in automated scoring systems.

Method: Fine-tuned BERT with four datasets (ELLs, non-ELLs, unbalanced mixed, balanced mixed) and analyzed 21 assessment items with varying ELL response sizes. Scoring accuracy and Mean Score Gaps (MSGs) were compared using Friedman tests.

Result: No significant AI bias or disparities were found with large datasets (30,000 and 1,000 ELL responses), but potential issues arose with smaller samples (200 ELL responses).

Conclusion: Training data size impacts scoring fairness; larger datasets mitigate bias, while smaller samples may introduce concerns.
...
### [60] [A Modular Approach for Clinical SLMs Driven by Synthetic Data with Pre-Instruction Tuning, Model Merging, and Clinical-Tasks Alignment](https://arxiv.org/abs/2505.10717)
*Jean-Philippe Corbeil,Amin Dada,Jean-Michel Attendu,Asma Ben Abacha,Alessandro Sordoni,Lucas Caccia,François Beaulieu,Thomas Lin,Jens Kleesiek,Paul Vozila*

Main category: cs.CL

TL;DR: The paper proposes a framework for adapting small language models (SLMs) into high-performing clinical models, introducing MediPhi and MediFlow collections, achieving significant improvements over base models and GPT-4.
...
Method: The framework includes pre-instruction tuning of experts on medical corpora, model merging, and clinical-tasks alignment. The CLUE benchmark is extended to CLUE+, and synthetic dataset MediFlow is created.

Result: MediPhi achieves relative improvements of 64.3% on medical entities, 49.5% on radiology reports, and 44% on ICD-10 coding, outperforming GPT-4 by 14%. Alignment further improves performance by 18.9%.

Conclusion: The proposed framework successfully adapts SLMs for clinical use, demonstrating significant performance gains and addressing data and cost challenges.
...
### [61] [AI-enhanced semantic feature norms for 786 concepts](https://arxiv.org/abs/2505.10718)
*Siddharth Suresh,Kushin Mukherjee,Tyler Giallanza,Xizheng Yu,Mia Patil,Jonathan D. Cohen,Timothy T. Rogers*
...
Method: Augmented human-generated feature norms with LLM responses and verified quality against human judgments.

Result: NOVA showed higher feature density and outperformed human-only datasets and word-embedding models in predicting semantic similarity.

Conclusion: Human conceptual knowledge is richer than previously captured, and validated LLMs can be powerful tools for cognitive science research.
...
### [62] [Tracr-Injection: Distilling Algorithms into Pre-trained Language Models](https://arxiv.org/abs/2505.10719)
*Tomás Vergara-Browne,Álvaro Soto*
...
<details>
  <summary>Details</summary>
Motivation: To bridge the gap between theoretical transformer capabilities and practical learnability from unsupervised data.

Method: Proposes tracr-injection to compile RASP algorithms into transformer weights, creating interpretable subspaces.

Result: Successfully injected 3 algorithms, improved out-of-distribution performance, and decoded variables from the residual stream.

Conclusion: tracr-injection enhances symbolic mechanisms in models and is released with experimental code.
...
### [63] [Model Performance-Guided Evaluation Data Selection for Effective Prompt Optimization](https://arxiv.org/abs/2505.10736)
*Ximing Dong,Shaowei Wang,Dayi Lin,Ahmed E. Hassan*

Main category: cs.CL

TL;DR: IPOMP is a two-stage method for automated prompt optimization, using semantic clustering and iterative refinement with real-time performance data, outperforming SOTA baselines in effectiveness and stability.
...
Method: IPOMP selects representative samples via semantic clustering and boundary analysis, then iteratively refines them using real-time model performance data.
...
### [64] [SemEval-2025 Task 7: Multilingual and Crosslingual Fact-Checked Claim Retrieval](https://arxiv.org/abs/2505.10740)
*Qiwei Peng,Robert Moro,Michal Gregor,Ivan Srba,Simon Ostermann,Marian Simko,Juraj Podroužek,Matúš Mesarčík,Jaroslav Kopčan,Anders Søgaard*

Main category: cs.CL

TL;DR: The paper discusses a shared task on multilingual claim retrieval at SemEval 2025, addressing the gap in disinformation detection for multilingual and low-resource languages. It highlights the best-performing systems and common approaches.


<details>
  <summary>Details</summary>
Motivation: To tackle the neglect of multilingual settings and low-resource languages in disinformation detection, the authors organized a shared task to advance research in this area.

Method: The task included two subtracks: monolingual (same language for posts and claims) and crosslingual (different languages). 179 participants contributed, with 52 test submissions.

Result: 23 out of 31 teams submitted system papers, revealing the best-performing systems and effective approaches for multilingual claim retrieval.

Conclusion: The shared task, dataset, and systems provide valuable insights for future research in multilingual claim retrieval and automated fact-checking.
...
### [65] [Ranked Voting based Self-Consistency of Large Language Models](https://arxiv.org/abs/2505.10772)
*Weiqin Wang,Yile Wang,Hui Huang*

Main category: cs.CL

TL;DR: The paper proposes generating ranked answers in chain-of-thought reasoning and using ranked voting methods (Instant-runoff, Borda count, mean reciprocal rank) to improve self-consistency and reasoning performance.


<details>
  <summary>Details</summary>
Motivation: Previous methods generate only a single answer per trial, ignoring potential alternatives, which limits the reliability of self-consistency in voting.

Method: Generate ranked answers in reasoning processes and apply three ranked voting methods (Instant-runoff, Borda count, mean reciprocal rank) to multiple responses.

Result: The method outperforms baselines on six datasets (three multiple-choice, three open-ended) using advanced language models.

Conclusion: Ranked answers and ranked voting enhance reasoning performance, demonstrating the value of leveraging alternative answers.
...
### [66] [A Systematic Analysis of Base Model Choice for Reward Modeling](https://arxiv.org/abs/2505.10775)
*Kian Ahrabian,Pegah Jandaghi,Negar Mokhberian,Sai Praneeth Karimireddy,Jay Pujara*
...
Method: A systematic analysis of base model selection effects, combining benchmarks and exploring post-training steps and data distributions.

Result: Performance improved by up to 14%, with benchmarks showing strong statistical relation to downstream performance. Combining benchmarks boosted selection by 18% on average.

Conclusion: Base model selection significantly impacts RM performance, and leveraging benchmarks and post-training steps can enhance results.
...
### [67] [Finetune-RAG: Fine-Tuning Language Models to Resist Hallucination in Retrieval-Augmented Generation](https://arxiv.org/abs/2505.10792)
*Zhan Peng Lee,Andre Lin,Calvin Tan*
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of irrelevant retrieved content causing hallucinations in LLMs, the paper aims to enhance factuality through fine-tuning.

Method: Proposes Finetune-RAG, a fine-tuning approach using a dataset simulating real-world retrieval imperfections, and Bench-RAG for evaluation under imperfect retrieval.

Result: Finetune-RAG improves factual accuracy by 21.2% over the base model.

Conclusion: The work introduces effective fine-tuning and evaluation methods for RAG, with open-sourced resources for community use.
...
### [68] [Relation Extraction Across Entire Books to Reconstruct Community Networks: The AffilKG Datasets](https://arxiv.org/abs/2505.10798)
*Erica Cai,Sean McQuade,Kevin Young,Brendan O'Connor*

Main category: cs.CL

TL;DR: AffilKG introduces six datasets pairing book scans with labeled knowledge graphs to evaluate KG extraction accuracy for downstream analysis, addressing gaps in current datasets.


<details>
  <summary>Details</summary>
Motivation: Current annotated datasets for evaluating KG extraction accuracy are disconnected, small, or overly complex, limiting their usefulness for downstream analysis.

Method: AffilKG provides six datasets with complete book scans and labeled knowledge graphs, including simple affiliation graphs and expanded KGs with diverse relation types.

Result: Preliminary experiments show significant variability in model performance, highlighting AffilKG's potential for benchmarking extraction errors and validating KG methods for social science research.

Conclusion: AffilKG fills a critical gap by enabling evaluation of KG extraction accuracy and its impact on graph-level analyses, supporting real-world social science applications.
...
### [69] [Enhancing Low-Resource Minority Language Translation with LLMs and Retrieval-Augmented Generation for Cultural Nuances](https://arxiv.org/abs/2505.10829)
*Chen-Chi Chang,Chong-Fu Li,Chu-Hsuan Lee,Hung-Shin Lee*

Main category: cs.CL

TL;DR: The study explores using LLMs and RAG for translating low-resource languages like Hakka, achieving BLEU scores up to 31%. The best model combined retrieval and advanced language modeling, improving lexical coverage and coherence.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of translating low-resource languages, particularly for specialized or culturally nuanced terms, by leveraging advanced language models and retrieval methods.
...
Result: BLEU scores ranged from 12% (dictionary-only) to 31% (RAG with Gemini 2.0). The best model improved lexical coverage and grammatical coherence.

Conclusion: The study highlights the need for curated resources, domain knowledge, and ethical collaboration to enhance translation accuracy and cultural preservation.
...
### [70] [Learning When to Think: Shaping Adaptive Reasoning in R1-Style Models via Multi-Stage RL](https://arxiv.org/abs/2505.10832)
*Songjun Tu,Jiahao Lin,Qichao Zhang,Xiangyu Tian,Linjing Li,Xiangyuan Lan,Dongbin Zhao*

Main category: cs.CL

TL;DR: AutoThink is a reinforcement learning framework that enables large reasoning models to dynamically decide when to engage in explicit reasoning, improving efficiency and accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the computational overhead and latency caused by unnecessary detailed reasoning in large reasoning models for simple problems.
...
### [71] [Multimodal Event Detection: Current Approaches and Defining the New Playground through LLMs and VLMs](https://arxiv.org/abs/2505.10836)
*Abhishek Dey,Aabha Bothera,Samhita Sarikonda,Rishav Aryan,Sanjay Kumar Podishetty,Akshay Havalgi,Gaurav Singh,Saurabh Srivastava*

Main category: cs.CL

TL;DR: The paper explores event detection on social media, comparing unimodal and multimodal models, including generative ones like GPT-4o. Multimodal methods outperform unimodal ones, but generative models lag in precision despite handling social media noise better.


<details>
  <summary>Details</summary>
Motivation: Traditional unimodal systems struggle with rapid, multimodal social media data, prompting the need for advanced models to improve event detection.

Method: Uses unimodal (ModernBERT, ConvNeXt-V2) and multimodal models, including generative ones (GPT-4o, LLaVA), and tests generative models with single modalities.

Result: Multimodal approaches outperform unimodal ones, but generative models lag in precision and event class generation compared to supervised methods.

Conclusion: Generative models handle social media noise well but need improvement in precision and event class accuracy for practical use.
...
### [72] [Have Multimodal Large Language Models (MLLMs) Really Learned to Tell the Time on Analog Clocks?](https://arxiv.org/abs/2505.10862)
*Tairan Fu,Miguel González,Javier Conde,Elena Merino-Gómez,Pedro Reviriego*

Main category: cs.CL

TL;DR: MLLMs struggle with telling time on analog clocks due to limited training data. This study tests GPT-4.1 to see if fine-tuning helps and evaluates if models truly learn or just memorize patterns.


<details>
  <summary>Details</summary>
Motivation: To understand why MLLMs fail at telling time on analog clocks and whether fine-tuning can address this limitation.

Method: Testing GPT-4.1 with various analog clocks to assess its ability to generalize and abstract time-telling.

Result: Models show progress but may rely on training data patterns rather than true understanding.

Conclusion: MLLMs still struggle with abstracting and generalizing time-telling, highlighting limitations in their learning capabilities.
...
### [73] [Improve Rule Retrieval and Reasoning with Self-Induction and Relevance ReEstimate](https://arxiv.org/abs/2505.10870)
*Ziyang Huang,Wangtao Sun,Jun Zhao,Kang Liu*

Main category: cs.CL

TL;DR: The paper introduces SIAR and R$^3$ to improve rule retrieval accuracy by leveraging LLMs for query augmentation and relevance re-estimation.


<details>
  <summary>Details</summary>
Motivation: Addressing low accuracy in rule retrieval due to semantic gaps between queries and rule representations, which hampers reasoning performance.

Method: Proposes SIAR for rule induction via LLMs and R$^3$ for relevance re-estimation of retrieved rules.

Result: Experiments show improved retrieval effectiveness and reasoning performance.

Conclusion: SIAR and R$^3$ effectively bridge the semantic gap and enhance rule retrieval for downstream reasoning.
...
### [74] [A Survey on the Safety and Security Threats of Computer-Using Agents: JARVIS or Ultron?](https://arxiv.org/abs/2505.10924)
*Ada Chen,Yongjiang Wu,Junyuan Zhang,Shu Yang,Jen-tse Huang,Kun Wang,Wenxuan Wang,Shuai Wang*

Main category: cs.CL

TL;DR: The paper systematizes knowledge on safety and security threats of Computer-Using Agents (CUAs), categorizing threats, proposing defenses, and summarizing benchmarks.


<details>
  <summary>Details</summary>
Motivation: The rise of AI-driven CUAs introduces novel safety and security risks, necessitating a structured analysis of vulnerabilities and defenses.

Method: A comprehensive literature review is conducted, focusing on defining CUAs, categorizing threats, proposing defenses, and summarizing evaluation metrics.

Result: The study provides a taxonomy of threats and defenses, along with benchmarks for assessing CUA safety and performance.
...
### [75] [Connecting the Dots: A Chain-of-Collaboration Prompting Framework for LLM Agents](https://arxiv.org/abs/2505.10936)
*Jiaxing Zhao,Hongbin Xie,Yuzhen Lei,Xuan Song,Zhuoran Shi,Lianxin Li,Shuangxue Liu,Haoran Zhang*
...
<details>
  <summary>Details</summary>
Motivation: Address limitations of single-agent chain-of-thought and multi-agent systems in business workflows, such as collaboration challenges and high token costs.

Method: Constructs an integrated knowledge graph and maintains a prompts tree for efficient retrieval of relevant prompt information.

Result: Cochain outperforms baselines in prompt engineering and multi-agent LLMs, with expert evaluations showing it surpasses GPT-4 when combined with a small model.

Conclusion: Cochain effectively enhances collaboration in business workflows by leveraging integrated knowledge and prompt retrieval, offering a cost-efficient solution.
...
### [76] [Reasoning with OmniThought: A Large CoT Dataset with Verbosity and Cognitive Difficulty Annotations](https://arxiv.org/abs/2505.10937)
*Wenrui Cai,Chengyu Wang,Junbing Yan,Jun Huang,Xiangzhong Fang*
...
<details>
  <summary>Details</summary>
Motivation: Current CoT datasets lack comprehensiveness and fail to account for internal CoT properties, hindering LRM advancement.

Method: Introduces OmniThought, a dataset with annotated RV and CD scores, and a self-reliant curation pipeline.

Result: Experiments show improved LRM training effectiveness, leading to high-performing models with enhanced reasoning.
...
### [77] [Accurate KV Cache Quantization with Outlier Tokens Tracing](https://arxiv.org/abs/2505.10938)
*Yi Su,Yuechi Zhou,Quantong Qiu,Juntao Li,Qingrong Xia,Ping Li,Xinyu Duan,Zhefeng Wang,Min Zhang*

Main category: cs.CL

TL;DR: The paper proposes a method to improve KV Cache quantization in LLMs by identifying and excluding outlier tokens, achieving better accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Large Language Models (LLMs) require significant computational resources, and KV Cache quantization balances memory and accuracy but is affected by unusual tokens.

Method: Develops a method to identify outlier tokens during decoding and exclude them from quantization.

Result: Achieves significant accuracy improvements under 2-bit quantization, reducing memory usage by 6.4x and increasing throughput by 2.3x.

Conclusion: The method effectively addresses outlier tokens, enhancing quantization accuracy and efficiency in LLMs.
...
### [78] [GenKnowSub: Improving Modularity and Reusability of LLMs through General Knowledge Subtraction](https://arxiv.org/abs/2505.10939)
*Mohammadtaha Bagherifard,Sahar Rajabi,Ali Edalat,Yadollah Yaghoobzadeh*
...
<details>
  <summary>Details</summary>
Motivation: Addressing the entanglement of general knowledge and task-specific adaptations in LLMs to enhance zero-shot generalization.

Method: Uses task-specific LoRA modules and a general-domain LoRA, subtracting general knowledge to create residual modules. Dynamically combines modules using the Arrow routing algorithm.

Result: Consistent performance gains in monolingual and cross-lingual benchmarks, demonstrated on Phi-3 and Phi-2 models.

Conclusion: GenKnowSub effectively improves LLM generalization without additional training, with potential for broader application.
...
### [79] [Semantic Aware Linear Transfer by Recycling Pre-trained Language Models for Cross-lingual Transfer](https://arxiv.org/abs/2505.10945)
*Seungyoon Lee,Seongtae Hong,Hyeonseok Moon,Heuiseok Lim*

Main category: cs.CL

TL;DR: SALT is a cross-lingual transfer technique that recycles target language PLM embeddings to enhance LLMs, outperforming other methods in performance and convergence.


<details>
  <summary>Details</summary>
Motivation: Existing methods for transferring multilingual LLMs to target languages may limit expressive capacity due to reliance on English-trained source models.

Method: SALT uses regression lines based on vocabulary overlap similarity to handle non-overlapping token embeddings, leveraging target language PLMs.

Result: SALT achieves superior performance, faster convergence, and excels in cross-lingual understanding compared to other methods.

Conclusion: SALT effectively enhances LLMs by leveraging PLMs, demonstrating scalability and improved cross-lingual transfer.
...
### [80] [The Way We Prompt: Conceptual Blending, Neural Dynamics, and Prompt-Induced Transitions in LLMs](https://arxiv.org/abs/2505.10948)
*Makoto Sato*

Main category: cs.CL

TL;DR: The paper explores how LLMs blend meaning using Conceptual Blending Theory, revealing parallels between AI and biological cognition through prompt-based experiments.
...
Method: Operationalizes Conceptual Blending Theory (CBT) with prompt-based methods to study Prompt-Induced Transitions (PIT) and Prompt-Induced Hallucinations (PIH).

Result: Uncovers structural similarities and differences between artificial and biological cognition, highlighting prompt engineering as a scientific tool.

Conclusion: Proposes prompt engineering as a method to study meaning's deep structure, advancing cognitive science through human-AI collaboration.
...
### [81] [Survey of End-to-End Multi-Speaker Automatic Speech Recognition for Monaural Audio](https://arxiv.org/abs/2505.10975)
*Xinlu He,Jacob Whitehill*
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenges of monaural multi-speaker ASR, such as data scarcity and overlapping speech, by reviewing E2E architectures that better integrate speech content and speaker identity.

Method: Systematic taxonomy of E2E approaches, analyzing SIMO and SISO paradigms, recent improvements, and extensions to long-form speech, followed by benchmark evaluations.

Result: Comparative analysis of methods, highlighting trade-offs and advancements in multi-speaker ASR, with insights into segmentation and hypothesis stitching.
...
### [82] [Illusion or Algorithm? Investigating Memorization, Emergence, and Symbolic Processing in In-Context Learning](https://arxiv.org/abs/2505.11004)
*Jingcheng Niu,Subhabrata Dutta,Ahmed Elshabrawy,Harish Tayyar Madabushi,Iryna Gurevych*

Main category: cs.CL

TL;DR: The paper investigates in-context learning (ICL) in large-scale Transformer LMs, showing it's not just memorization but also not a fully symbolic algorithm. It uses the Pythia suite to analyze ICL's mechanisms and implications.


<details>
  <summary>Details</summary>
Motivation: To clarify the controversial understanding of ICL in LMs, addressing debates about whether it's memorization or symbolic algorithmic development.

Method: Introduces investigative tasks and a novel method using the Pythia scaling suite, including interim checkpoints, to analyze ICL performance and mechanistic subspaces.

Result: ICL goes beyond memorization but isn't a standalone symbolic algorithm. Insights into training dynamics, model capabilities, and interpretability are provided.

Conclusion: Advances ICL understanding, offering insights for model improvement and AI security guidelines.
...
### [83] [Reconstructing Syllable Sequences in Abugida Scripts with Incomplete Inputs](https://arxiv.org/abs/2505.11008)
*Ye Kyaw Thu,Thazin Myint Oo*

Main category: cs.CL

TL;DR: The paper investigates syllable sequence prediction in Abugida languages using Transformer models, highlighting the importance of consonant sequences and challenges with vowels.


<details>
  <summary>Details</summary>
Motivation: To improve understanding and applications like text prediction and spelling correction in Abugida languages.

Method: Transformer-based models trained on the ALT dataset, testing reconstruction from incomplete inputs (consonant/vowel sequences, partial/masked syllables).

Result: Consonant sequences yield high BLEU scores; vowel sequences are more challenging. Model excels in partial/masked syllable tasks.
...
### [84] [Review-Instruct: A Review-Driven Multi-Turn Conversations Generation Method for Large Language Models](https://arxiv.org/abs/2505.11010)
*Jiangxu Wu,Cong Wang,TianHuang Su,Jun Yang,Haozhi Lin,Chao Zhang,Ming Peng,Kai Shi,SongPan Yang,BinQing Pan,ZiXian Li,Ni Yang,ZhenYu Yang*

Main category: cs.CL

TL;DR: Review-Instruct is a framework using a multi-agent 'Ask-Respond-Review' process to generate high-quality multi-turn dialogue data, improving LLM performance.
...
Method: Proposes Review-Instruct, a framework with Candidate, Reviewers, and Chairman roles to iteratively refine instructions via feedback. Uses Alpaca dataset and fine-tunes LLaMA2-13B.

Result: Achieves 2.9% gain on MMLU-Pro and 2% on MT-Bench over prior LLaMA2-13B models. Ablation studies confirm Review stage and multiple Reviewers' importance.

Conclusion: Review-driven, multi-agent frameworks can generate scalable, high-quality conversational data, enhancing LLM performance.
...
### [85] [StRuCom: A Novel Dataset of Structured Code Comments in Russian](https://arxiv.org/abs/2505.11026)
*Maria Dziuba,Valentin Malykh*

Main category: cs.CL

TL;DR: StRuCom is a large-scale dataset for Russian code documentation, improving model performance over baselines.


<details>
  <summary>Details</summary>
Motivation: Existing models perform poorly for Russian code comments compared to English, creating a need for a dedicated dataset.

Method: Combines human-written comments from Russian GitHub with synthetic ones, validated for compliance with multiple programming languages.

Result: Fine-tuning Qwen2.5-Coder models on StRuCom shows significant improvements in chrf++ and BERTScore.
...
### [86] [OntoURL: A Benchmark for Evaluating Large Language Models on Symbolic Ontological Understanding, Reasoning and Learning](https://arxiv.org/abs/2505.11031)
*Xiao Zhang,Huiyuan Lai,Qianru Meng,Johan Bos*
...
<details>
  <summary>Details</summary>
Motivation: To address the underexplored capability of LLMs in processing structured symbolic knowledge like ontologies.

Method: Proposes a taxonomy of LLMs' ontological capabilities and develops OntoURL, a benchmark with 15 tasks across 40 ontologies to evaluate understanding, reasoning, and learning.
...
### [87] [CAMEO: Collection of Multilingual Emotional Speech Corpora](https://arxiv.org/abs/2505.11051)
*Iwona Christop,Maciej Czajka*

Main category: cs.CL

TL;DR: CAMEO is a multilingual emotional speech dataset collection for emotion recognition research, ensuring accessibility, reproducibility, and benchmarking.


<details>
  <summary>Details</summary>
Motivation: To provide a standardized, accessible resource for speech emotion recognition research across languages and emotional states.

Method: Curated datasets with selection criteria, normalization, and performance evaluation of models.

Result: Publicly available collection with metadata and a leaderboard on Hugging Face.

Conclusion: CAMEO facilitates reproducible and standardized research in speech emotion recognition.
...
### [88] [BLEUBERI: BLEU is a surprisingly effective reward for instruction following](https://arxiv.org/abs/2505.11080)
*Yapei Chang,Yekyung Kim,Michael Krumdick,Amir Zadeh,Chuan Li,Chris Tanner,Mohit Iyyer*

Main category: cs.CL

TL;DR: BLEUBERI uses BLEU as a reward function for RL-based alignment, showing competitive performance with traditional reward models.


<details>
  <summary>Details</summary>
Motivation: Reward models are costly to train, so the paper explores if simpler, reference-based metrics like BLEU can replace them.

Method: Develops BLEUBERI, which identifies challenging instructions and applies GRPO using BLEU as the reward function.

Result: BLEUBERI-trained models match reward model-aligned models in performance and generate more factually grounded outputs.

Conclusion: String-matching metrics like BLEU are cheap and effective alternatives to reward models for alignment.
...
### [89] [Towards Better Evaluation for Generated Patent Claims](https://arxiv.org/abs/2505.11095)
*Lekang Jiang,Pascal A Scherz,Stephan Goetz*

Main category: cs.CL

TL;DR: The paper introduces Patent-CE, a benchmark for evaluating patent claims, and PatClaimEval, a novel evaluation method, to address inconsistencies in automated patent claim generation assessments.


<details>
  <summary>Details</summary>
Motivation: The complexity of drafting patent claims and the inconsistency between automated metrics and human evaluations motivate the need for a better evaluation framework.

Method: Patent-CE includes expert-annotated evaluations, and PatClaimEval is proposed as a multi-dimensional evaluation method for patent claims.

Result: PatClaimEval shows the highest correlation with human expert evaluations across all criteria.

Conclusion: This work lays the foundation for more accurate evaluations of automated patent claim generation systems.
...
### [90] [Scaling Reasoning can Improve Factuality in Large Language Models](https://arxiv.org/abs/2505.11140)
*Mike Zhang,Johannes Bjerva,Russa Biswas*

Main category: cs.CL

TL;DR: The paper investigates whether longer reasoning chains improve factual accuracy in LLMs beyond math tasks, focusing on open-domain QA. It fine-tunes models with enriched reasoning traces and finds smaller models improve accuracy, with test-time compute further boosting performance by 2-8%.


<details>
  <summary>Details</summary>
Motivation: To determine if extended reasoning chains enhance factual accuracy in LLMs, especially in open-domain QA, beyond mathematical contexts.

Method: Distills reasoning traces from large models, fine-tunes various models (small to large), enriches traces with knowledge graph paths, and evaluates on 22.6K questions across six datasets.

Result: Smaller reasoning models improve factual accuracy; test-time compute boosts accuracy by 2-8%.

Conclusion: Longer reasoning and test-time compute enhance factual accuracy in open-domain QA, with smaller models showing notable improvements.
...
### [91] [SoLoPO: Unlocking Long-Context Capabilities in LLMs via Short-to-Long Preference Optimization](https://arxiv.org/abs/2505.11166)
*Huashan Sun,Shengyi Liao,Yansen Han,Yu Bai,Yang Gao,Cheng Fu,Weizhou Shen,Fanqi Wan,Ming Yan,Ji Zhang,Fei Huang*

Main category: cs.CL

TL;DR: The paper proposes SoLoPO, a framework to improve long-context alignment in LLMs by decoupling preference optimization into short-context PO and short-to-long reward alignment, enhancing efficiency and performance.


<details>
  <summary>Details</summary>
Motivation: LLMs struggle with real-world long-context utilization due to data quality, training inefficiencies, and lack of optimization objectives.

Method: SoLoPO decouples long-context preference optimization into short-context PO and SoLo-RA, ensuring reward consistency between short and long contexts.

Result: SoLoPO improves length and domain generalization, computational efficiency, and memory efficiency across benchmarks.

Conclusion: SoLoPO effectively addresses long-context alignment challenges and enhances LLM performance.
...
### [92] [Low-Resource Language Processing: An OCR-Driven Summarization and Translation Pipeline](https://arxiv.org/abs/2505.11177)
*Hrishit Madhavi,Jacob Cherian,Yuvraj Khamkar,Dhananjay Bhagat*

Main category: cs.CL

TL;DR: An end-to-end multilingual system for extracting and processing text from image documents using OCR, LLMs for translation/summarization, and additional NLP tasks like sentiment analysis and topic classification.
...
Method: Uses Tesseract OCR for text extraction, Gemini APIs for cross-lingual tasks, and additional NLP modules (TensorFlow, Transformers, Regex) for sentiment, topic, and date extraction. Integrated into a Gradio interface.

Result: Demonstrates a practical application combining libraries, models, and APIs to enhance multilingual document processing.

Conclusion: The system effectively addresses language barriers in image-based documents, showcasing real-world utility.
...
### [93] [NoPE: The Counting Power of Transformers with No Positional Encodings](https://arxiv.org/abs/2505.11199)
*Chris Köcher,Alexander Kozachinskiy,Anthony Widjaja Lin,Marco Sälzer,Georg Zetzsche*
...
<details>
  <summary>Details</summary>
Motivation: To explore the expressiveness of NoPE-transformers with average hard attention and characterize their capabilities.

Method: Analyze NoPE-transformers with average hard attention, characterizing their expressiveness as semi-algebraic sets and comparing them to other models.

Result: NoPE-AHATs can express nonnegative integer solutions to polynomial equations (undecidable problems) but not PARITY. Their analysis is undecidable.

Conclusion: NoPE-transformers with average hard attention are highly expressive for complex counting tasks but limited in simple ones, and their analysis is undecidable.
...
### [94] [HAPO: Training Language Models to Reason Concisely via History-Aware Policy Optimization](https://arxiv.org/abs/2505.11225)
*Chengyu Huang,Zhengxin Zhang,Claire Cardie*

Main category: cs.CL

TL;DR: HAPO (History-Aware Policy Optimization) improves LLM efficiency by leveraging historical data to generate concise responses without significant accuracy loss.


<details>
  <summary>Details</summary>
Motivation: Existing methods for efficient test-time scaling in LLMs lack historical context, limiting their ability to progressively optimize response conciseness.

Method: HAPO tracks history states (e.g., minimum length of correct responses) and uses a novel length reward function to incentivize concise solutions while maintaining correctness.

Result: HAPO reduces response lengths by 33-59% with only 2-5% accuracy drops across math benchmarks.

Conclusion: HAPO effectively balances correctness and efficiency, enhancing LLMs' ability to produce concise reasoning.
...
### [95] [Semantic Caching of Contextual Summaries for Efficient Question-Answering with Language Models](https://arxiv.org/abs/2505.11271)
*Camille Couturier,Spyros Mastorakis,Haiying Shen,Saravan Rajmohan,Victor Rühle*
...
<details>
  <summary>Details</summary>
Motivation: Addressing high computational overhead, memory usage, and network bandwidth in distributed systems for LLM-based QA.

Method: Introduces semantic caching to store and reuse intermediate contextual summaries for similar queries.

Result: Demonstrates 50-60% reduction in redundant computations with comparable accuracy on datasets like NaturalQuestions and TriviaQA.

Conclusion: The approach balances computational cost and response quality, crucial for real-time AI assistants.
...
### [96] [Search and Refine During Think: Autonomous Retrieval-Augmented Reasoning of LLMs](https://arxiv.org/abs/2505.11277)
*Yaorui Shi,Shihan Li,Chang Wu,Zhiyuan Liu,Junfeng Fang,Hengxing Cai,An Zhang,Xiang Wang*

Main category: cs.CL

TL;DR: AutoRefine is a reinforcement learning framework that improves retrieval-augmented reasoning by refining knowledge iteratively, outperforming existing methods in QA tasks.


<details>
  <summary>Details</summary>
Motivation: Large language models (LLMs) are limited by their static knowledge; retrieval-augmented methods often retrieve noisy or irrelevant information, hindering reasoning.

Method: AutoRefine uses a "search-and-refine-during-think" paradigm, incorporating knowledge refinement steps between searches and tailored retrieval-specific rewards via group relative policy optimization.

Result: AutoRefine outperforms existing methods, especially in multi-hop QA, by issuing higher-quality searches and synthesizing evidence effectively.

Conclusion: AutoRefine enhances retrieval-augmented reasoning, demonstrating significant improvements in complex reasoning tasks.
...
### [97] [Temporal fine-tuning for early risk detection](https://arxiv.org/abs/2505.11280)
*Horacio Thompson,Esaú Villatoro-Tello,Manuel Montes-y-Gómez,Marcelo Errecalde*

Main category: cs.CL

TL;DR: The paper proposes temporal fine-tuning for transformer-based models to improve Early Risk Detection (ERD) by incorporating time into learning, achieving competitive results in depression and eating disorder tasks.


<details>
  <summary>Details</summary>
Motivation: Early Risk Detection (ERD) on the Web requires balancing precision and speed, but standard metrics and methods may not suffice. The paper aims to address this by integrating time into model training.

Method: The authors introduce temporal fine-tuning, a method to explicitly incorporate time into transformer-based models, enabling analysis of user post histories and context-aware tuning.

Result: The method achieved competitive results in depression and eating disorder detection tasks, optimizing decisions by considering context and time progress.

Conclusion: Temporal fine-tuning effectively combines precision and speed in ERD, leveraging transformers' power to address the challenge as a single objective.
...
### [98] [Probing Subphonemes in Morphology Models](https://arxiv.org/abs/2505.11297)
*Gal Astrach,Yuval Pinter*

Main category: cs.CL

TL;DR: Transformers perform well in morphological inflection but struggle with cross-language generalization. A probing method reveals they capture local phonological features better than long-distance ones, impacting training strategies.


<details>
  <summary>Details</summary>
Motivation: To understand why transformers generalize poorly across languages and morphological rules, focusing on their ability to encode phonological and subphonemic features.

Method: A language-agnostic probing method is introduced to analyze phonological feature encoding in transformers trained on phonemes, tested across seven diverse languages.

Result: Local phonological features (e.g., final-obstruent devoicing) are well-captured in phoneme embeddings, while long-distance dependencies (e.g., vowel harmony) are better represented in the transformer's encoder.

Conclusion: The findings highlight the importance of subphonemic feature acquisition in training morphological models, suggesting empirical strategies for improvement.
...
### [99] [XtraGPT: LLMs for Human-AI Collaboration on Controllable Academic Paper Revision](https://arxiv.org/abs/2505.11336)
*Nuo Chen,Andre Lin HuiKai,Jiaying Wu,Junyi Hou,Zining Zhang,Qian Wang,Xidong Wang,Bingsheng He*

Main category: cs.CL

TL;DR: The paper introduces XtraGPT, a human-AI collaboration framework for academic paper revision, addressing limitations of current LLMs in scientific writing. It uses a dataset of 7,040 annotated papers to develop context-aware, instruction-guided models, outperforming baselines and nearing proprietary system quality.


<details>
  <summary>Details</summary>
Motivation: Current LLMs fall short in supporting high-quality scientific writing, lacking conceptual coherence and iterative revision support.

Method: The authors create a dataset of 7,040 research papers with 140,000 instruction-response pairs and develop XtraGPT, a suite of open-source LLMs (1.5B to 14B parameters) for context-aware writing assistance.

Result: XtraGPT outperforms same-scale baselines and approaches proprietary system quality, validated by automated and human evaluations.

Conclusion: The proposed framework effectively improves scientific drafts, demonstrating the potential of human-AI collaboration in academic writing.
...
### [100] [Benchmarking Critical Questions Generation: A Challenging Reasoning Task for Large Language Models](https://arxiv.org/abs/2505.11341)
*Banca Calvo Figueras,Rodrigo Agerri*

Main category: cs.CL

TL;DR: The paper introduces a comprehensive approach for Critical Questions Generation (CQs-Gen), including a new dataset, evaluation methods, and benchmarks for LLMs, aiming to advance research in automated reasoning and human critical thinking.


<details>
  <summary>Details</summary>
Motivation: To address the lack of datasets and evaluation standards for CQs-Gen, which is crucial for fostering critical thinking by challenging assumptions in arguments.

Method: Constructs a large-scale manually-annotated dataset and investigates automatic evaluation methods, identifying LLM-based reference techniques as the most human-correlated.

Result: Zero-shot evaluation of 11 LLMs establishes a baseline, highlighting task difficulty. Data, code, and a leaderboard are provided for further research.

Conclusion: The work supports future research in CQs-Gen, emphasizing its potential benefits for automated reasoning and human critical thinking.
...
### [101] [LegoSLM: Connecting LLM with Speech Encoder using CTC Posteriors](https://arxiv.org/abs/2505.11352)
*Rao Ma,Tongzhou Chen,Kartik Audhkhasi,Bhuvana Ramabhadran*
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for combining speech encoders and LLMs are suboptimal or inflexible.
...
Result: 49% WERR improvement over baseline on ASR tasks and modularity in model switching.

Conclusion: LegoSLM offers a flexible, high-performance solution for integrating speech encoders and LLMs.
...
### [102] [GuideBench: Benchmarking Domain-Oriented Guideline Following for LLM Agents](https://arxiv.org/abs/2505.11368)
*Lingxiao Diao,Xinyue Xu,Wanxuan Sun,Cheng Yang,Zhuosheng Zhang*

Main category: cs.CL

TL;DR: GuideBench is introduced to evaluate LLMs' ability to follow domain-oriented guidelines, addressing adherence, robustness to updates, and human alignment.
...
Method: GuideBench assesses LLMs on three aspects: rule adherence, robustness to updates, and human preference alignment.

Result: Experiments show significant room for improvement in LLMs' guideline-following capabilities.

Conclusion: GuideBench fills a critical gap in evaluating LLMs for domain-oriented applications, highlighting areas for future enhancement.
...
### [103] [A computational system to handle the orthographic layer of tajwid in contemporary Quranic Orthography](https://arxiv.org/abs/2505.11379)
*Alicia González Martínez*

Main category: cs.CL

TL;DR: The paper explores the systematicity of tajwid rules in the Cairo Quran using a digital edition and a Python module to manipulate orthographic layers, aiming to align and compare Quranic manuscripts computationally.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand the phonetic and prosodic processes in the Quran by analyzing the rules of tajwid and their representation in CQO, leveraging digital tools for broader manuscript comparisons.

Method: A Python module was developed to add or remove the orthographic layer of tajwid in CQO, using a fully encoded digital edition of the Cairo Quran to study its systematic rules.

Result: The rules of tajwid in the Cairo Quran provide a precise framework for phonetic and prosodic analysis, enabling computational alignment and comparison of Quranic manuscripts.

Conclusion: The study offers a powerful computational framework for analyzing Quranic manuscripts and diacritic notation systems, facilitating broader research on Arabic script and textual phenomena.
...
### [104] [CARES: Comprehensive Evaluation of Safety and Adversarial Robustness in Medical LLMs](https://arxiv.org/abs/2505.11413)
*Sijia Chen,Xiaomin Li,Mengxue Zhang,Eric Hanchen Jiang,Qingcheng Zeng,Chen-Hsiang Yu*

Main category: cs.CL

TL;DR: CARES is a benchmark for evaluating LLM safety in healthcare, addressing gaps in clinical specificity, harm levels, and jailbreak attacks. It includes 18,000+ prompts, a three-way response protocol, and a Safety Score. Findings show LLMs are vulnerable to subtle rephrasing of harmful prompts and over-refuse safe queries. A mitigation strategy using a lightweight classifier is proposed.


<details>
  <summary>Details</summary>
Motivation: To address the lack of clinical specificity, graded harmfulness levels, and coverage of jailbreak-style attacks in existing benchmarks for LLM safety in healthcare.

Method: Introduces CARES, a benchmark with 18,000+ prompts across eight medical safety principles, four harm levels, and four prompting styles. Uses a three-way response protocol (Accept, Caution, Refuse) and a Safety Score metric.

Result: State-of-the-art LLMs are vulnerable to jailbreaks via subtle rephrasing and over-refuse safe queries.

Conclusion: CARES offers a rigorous framework for testing and improving medical LLM safety, with a proposed mitigation strategy using a lightweight classifier.
...
### [105] [Towards Cultural Bridge by Bahnaric-Vietnamese Translation Using Transfer Learning of Sequence-To-Sequence Pre-training Language Model](https://arxiv.org/abs/2505.11421)
*Phan Tran Minh Dat,Vo Hoang Nhat Khang,Quan Thanh Tho*

Main category: cs.CL

TL;DR: The paper addresses Bahnaric-Vietnamese translation challenges using transfer learning and data augmentation, achieving effective results despite limited resources.


<details>
  <summary>Details</summary>
Motivation: To bridge cultural gaps between Bahnaric and Vietnamese ethnic groups in Vietnam by enabling translation, despite scarce Bahnaric linguistic resources.

Method: Leverages a pre-trained Vietnamese sequence-to-sequence model, transfers learning to Bahnaric-Vietnamese translation, and enhances datasets with augmentation and heuristics.

Result: The approach proves highly effective, improving translation accuracy and resource utilization.

Conclusion: The method successfully addresses resource imbalance, aids language preservation, and fosters mutual understanding between the two ethnic groups.
...
### [106] [When Thinking Fails: The Pitfalls of Reasoning for Instruction-Following in LLMs](https://arxiv.org/abs/2505.11423)
*Xiaomin Li,Zhou Yu,Zhiwei Zhang,Xupeng Chen,Ziji Zhang,Yingying Zhuang,Narayanan Sadagopan,Anurag Beniwal*

Main category: cs.CL

TL;DR: Explicit chain-of-thought (CoT) reasoning in large language models can degrade instruction-following accuracy. The paper identifies patterns of reasoning's impact, proposes a metric (constraint attention), and introduces mitigation strategies like selective reasoning.


<details>
  <summary>Details</summary>
Motivation: To uncover and address the overlooked phenomenon where explicit CoT reasoning harms instruction-following accuracy in large language models.

Method: Evaluated 15 models on IFEval and ComplexBench, analyzed patterns via case studies and attention-based analysis, and proposed four mitigation strategies.

Result: CoT reasoning often diverts attention from instruction-relevant tokens, but selective reasoning strategies (e.g., classifier-selective reasoning) can recover performance.

Conclusion: This work systematically exposes reasoning-induced failures and offers practical solutions, marking the first such study.
...
### [107] [GODBench: A Benchmark for Multimodal Large Language Models in Video Comment Art](https://arxiv.org/abs/2505.11436)
*Chenkai Zhang,Yiming Lei,Zeming Liu,Haitao Leng,Shaoguo Liu,Tingting Gao,Qingjie Liu,Yunhong Wang*

Main category: cs.CL

TL;DR: GODBench is a new benchmark for evaluating MLLMs' ability to create creative video comments, and RoT is a reasoning framework to enhance their creativity.


<details>
  <summary>Details</summary>
Motivation: Existing MLLMs and benchmarks struggle with creative expressions like humor and satire in video comments.

Method: Introduce GODBench (video-text benchmark) and Ripple of Thought (RoT), a multi-step reasoning framework.

Result: RoT improves MLLMs' creative composing, while current methods still face challenges.

Conclusion: RoT shows promise for advancing MLLM-based creativity, with GODBench as a tool for evaluation.
...
### [108] [Is Compression Really Linear with Code Intelligence?](https://arxiv.org/abs/2505.11441)
*Xianzhen Luo,Shijie Xuyang,Tianhao Cheng,Zheng Chu,Houyi Li,ziqi wang,Siming Huang,Qingfu Zhu,Qiufeng Wang,Xiangyu Zhang,Shuigeng Zhou,Wanxiang Che*

Main category: cs.CL

TL;DR: The paper explores the relationship between data compression (measured as BPC) and code intelligence in LLMs, introducing Format Annealing for fair evaluation and revealing a logarithmic, not linear, relationship.


<details>
  <summary>Details</summary>
Motivation: To clarify the relationship between compression and code intelligence in LLMs, addressing gaps in prior work that overlooked code diversity and fair evaluation.

Method: Evaluates diverse Code LLMs on multi-language, multi-task benchmarks using Format Annealing for fair assessment and a novel GitHub-derived validation set for BPC measurement.

Result: Empirical findings show a logarithmic relationship between code intelligence and BPC, refining prior linear hypotheses.

Conclusion: The study offers a nuanced understanding of compression's role in code intelligence and provides a robust evaluation framework for the code domain.
...
### [109] [Disentangling Reasoning and Knowledge in Medical Large Language Models](https://arxiv.org/abs/2505.11462)
*Rahul Thapa,Qingyang Wu,Kevin Wu,Harrison Zhang,Angela Zhang,Eric Wu,Haotian Ye,Suhana Bedi,Nevin Aresh,Joseph Boen,Shriya Reddy,Ben Athiwaratkun,Shuaiwen Leon Song,James Zou*
...
<details>
  <summary>Details</summary>
Motivation: To address the mixing of reasoning and factual recall in current medical reasoning benchmarks for LLMs.

Method: Uses a PubMedBERT classifier to split benchmarks, evaluates models, and trains BioMed-R1 with fine-tuning and RL on reasoning-heavy examples.

Result: Biomedical models struggle with reasoning, while general models are more robust. BioMed-R1 outperforms similarly sized models.

Conclusion: Future improvements may involve clinical case reports and adversarial training.
...
### [110] [No Gold Standard, No Problem: Reference-Free Evaluation of Taxonomies](https://arxiv.org/abs/2505.11470)
*Pascal Wullschleger,Majid Zarharan,Donnacha Daly,Marc Pouly,Jennifer Foster*
...
<details>
  <summary>Details</summary>
Motivation: Existing metrics for taxonomy quality evaluation may not cover all types of errors, such as robustness and logical adequacy.

Method: 1. Robustness metric: correlation between semantic and taxonomic similarity. 2. Logical adequacy metric: uses Natural Language Inference. Both tested on five taxonomies.

Result: Metrics correlate well with F1 scores against gold-standard taxonomies.
...
### [111] [HelpSteer3-Preference: Open Human-Annotated Preference Data across Diverse Tasks and Languages](https://arxiv.org/abs/2505.11475)
*Zhilin Wang,Jiaqi Zeng,Olivier Delalleau,Hoo-Chang Shin,Felipe Soares,Alexander Bukharin,Ellie Evans,Yi Dong,Oleksii Kuchaiev*

Main category: cs.CL

TL;DR: HelpSteer3-Preference is a high-quality, diverse, and openly licensed (CC-BY-4.0) preference dataset for training language models with RLHF, achieving top performance in benchmarks.


<details>
  <summary>Details</summary>
Motivation: There is a constant need for advancing the quality and diversity of preference data to improve instruction-following language models.

Method: The paper introduces HelpSteer3-Preference, a dataset with over 40,000 human-annotated samples spanning diverse applications like STEM, coding, and multilingual tasks. Reward Models (RMs) are trained using this dataset.

Result: The trained RMs achieve top performance on RM-Bench (82.4%) and JudgeBench (73.7%), a ~10% improvement over previous results. The dataset also enables training Generative RMs and aligning policy models with RLHF.

Conclusion: HelpSteer3-Preference significantly advances the field by providing a high-quality, diverse dataset for RLHF, leading to improved model performance.
...
### [112] [Improving Assembly Code Performance with Large Language Models via Reinforcement Learning](https://arxiv.org/abs/2505.11480)
*Anjiang Wei,Tarun Suresh,Huanmi Tan,Yinglun Xu,Gagandeep Singh,Ke Wang,Alex Aiken*

Main category: cs.CL

TL;DR: LLMs trained with reinforcement learning (PPO) optimize assembly code, achieving 96% test pass rates and 1.47x speedup over gcc -O3.


<details>
  <summary>Details</summary>
Motivation: Explore LLMs' potential for code optimization, especially in assembly where fine-grained control enables performance improvements.

Method: Reinforcement learning framework using PPO, with rewards for correctness and performance relative to gcc -O3. Benchmark of 8,072 programs.
...
### [113] [SoftCoT++: Test-Time Scaling with Soft Chain-of-Thought Reasoning](https://arxiv.org/abs/2505.11484)
*Yige Xu,Xu Guo,Zhiwei Zeng,Chunyan Miao*

Main category: cs.CL

TL;DR: SoftCoT++ extends SoftCoT for Test-Time Scaling by enabling diverse exploration of thinking paths in continuous latent space, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Existing TTS methods in continuous latent space limit diverse reasoning paths due to fixed latent representations. SoftCoT++ aims to overcome this by introducing perturbations and contrastive learning.

Method: SoftCoT++ perturbs latent thoughts via specialized initial tokens and uses contrastive learning to enhance diversity in soft thought representations.

Result: Experiments on five reasoning benchmarks and two LLM architectures show SoftCoT++ significantly improves SoftCoT and outperforms it with self-consistency scaling.

Conclusion: SoftCoT++ effectively enhances reasoning performance in continuous-space TTS, demonstrating strong compatibility with conventional scaling techniques.
...
### [114] [Modeling cognitive processes of natural reading with transformer-based Language Models](https://arxiv.org/abs/2505.11485)
*Bruno Bianchi,Fermín Travi,Juan E. Kamienkowski*

Main category: cs.CL

TL;DR: Transformer-based models (GPT2, LLaMA-7B, LLaMA2-7B) outperform older models in explaining Gaze Duration variance but still fall short of human predictability.


<details>
  <summary>Details</summary>
Motivation: To explore how advanced NLP models (transformers) compare to older models in explaining human reading behaviors (Gaze Duration).

Method: Evaluated transformer models (GPT2, LLaMA-7B, LLaMA2-7B) against human predictability data from Rioplantense Spanish readers.

Result: Transformers outperform N-grams and LSTMs but still cannot fully account for human predictability in Gaze Duration.

Conclusion: State-of-the-art language models predict language differently than humans, indicating a gap in modeling human cognition.
...
### [115] [Robust Emotion Recognition via Bi-Level Self-Supervised Continual Learning](https://arxiv.org/abs/2505.10575)
...
### [116] [Bias and Generalizability of Foundation Models across Datasets in Breast Mammography](https://arxiv.org/abs/2505.10579)
...
### [117] [Relative Drawing Identification Complexity is Invariant to Modality in Vision-Language Models](https://arxiv.org/abs/2505.10583)
...
### [118] [Aquarius: A Family of Industry-Level Video Generation Models for Marketing Scenarios](https://arxiv.org/abs/2505.10584)
...
### [119] [Efficient Malicious UAV Detection Using Autoencoder-TSMamba Integration](https://arxiv.org/abs/2505.10585)
...
### [120] [Super-Resolution Generative Adversarial Networks based Video Enhancement](https://arxiv.org/abs/2505.10589)
*Kağan ÇETİN*
...
### [121] [ARFC-WAHNet: Adaptive Receptive Field Convolution and Wavelet-Attentive Hierarchical Network for Infrared Small Target Detection](https://arxiv.org/abs/2505.10595)
...
### [122] [SRMamba: Mamba for Super-Resolution of LiDAR Point Clouds](https://arxiv.org/abs/2505.10601)
...
### [123] [MIRAGE: A Multi-modal Benchmark for Spatial Perception, Reasoning, and Intelligence](https://arxiv.org/abs/2505.10604)
...
### [124] [MMLongBench: Benchmarking Long-Context Vision-Language Models Effectively and Thoroughly](https://arxiv.org/abs/2505.10610)
...
### [125] [Mitigate Language Priors in Large Vision-Language Models by Cross-Images Contrastive Decoding](https://arxiv.org/abs/2505.10634)
...
### [126] [Advancing Multiple Instance Learning with Continual Learning for Whole Slide Imaging](https://arxiv.org/abs/2505.10649)
...
### [127] [CLIP Embeddings for AI-Generated Image Detection: A Few-Shot Study with Lightweight Classifier](https://arxiv.org/abs/2505.10664)
*Ziyang Ou*
...
### [128] [GA3CE: Unconstrained 3D Gaze Estimation with Gaze-Aware 3D Context Encoding](https://arxiv.org/abs/2505.10671)
...
### [129] [Are Spatial-Temporal Graph Convolution Networks for Human Action Recognition Over-Parameterized?](https://arxiv.org/abs/2505.10679)
...
### [131] [Automated Detection of Salvin's Albatrosses: Improving Deep Learning Tools for Aerial Wildlife Surveys](https://arxiv.org/abs/2505.10737)
...
### [132] [IMAGE-ALCHEMY: Advancing subject fidelity in personalised text-to-image generation](https://arxiv.org/abs/2505.10743)
...
### [133] [Mapping Semantic Segmentation to Point Clouds Using Structure from Motion for Forest Analysis](https://arxiv.org/abs/2505.10751)
...
### [134] [Benchmarking performance, explainability, and evaluation strategies of vision-language models for surgery: Challenges and opportunities](https://arxiv.org/abs/2505.10764)
...
### [135] [Unifying Segment Anything in Microscopy with Multimodal Large Language Model](https://arxiv.org/abs/2505.10769)
...
### [136] [Completely Weakly Supervised Class-Incremental Learning for Semantic Segmentation](https://arxiv.org/abs/2505.10781)
...
### [137] [SynRailObs: A Synthetic Dataset for Obstacle Detection in Railway Scenarios](https://arxiv.org/abs/2505.10784)
...
### [138] [EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes](https://arxiv.org/abs/2505.10787)
...
### [139] [MoCLIP: Motion-Aware Fine-Tuning and Distillation of CLIP for Human Motion Generation](https://arxiv.org/abs/2505.10810)
...
### [140] [From Embeddings to Accuracy: Comparing Foundation Models for Radiographic Classification](https://arxiv.org/abs/2505.10823)
...
### [141] [A High-Performance Thermal Infrared Object Detection Framework with Centralized Regulation](https://arxiv.org/abs/2505.10825)
...
### [142] [NeuSEditor: From Multi-View Images to Text-Guided Neural Surface Edits](https://arxiv.org/abs/2505.10827)
...
### [143] [RefPose: Leveraging Reference Geometric Correspondences for Accurate 6D Pose Estimation of Unseen Objects](https://arxiv.org/abs/2505.10841)
...
### [144] [A Convolution-Based Gait Asymmetry Metric for Inter-Limb Synergistic Coordination](https://arxiv.org/abs/2505.10869)
...
### [145] [A Light and Smart Wearable Platform with Multimodal Foundation Model for Enhanced Spatial Reasoning in People with Blindness and Low Vision](https://arxiv.org/abs/2505.10875)
...
### [146] [PoseBench3D: A Cross-Dataset Analysis Framework for 3D Human Pose Estimation](https://arxiv.org/abs/2505.10888)
...
### [147] [Patient-Specific Dynamic Digital-Physical Twin for Coronary Intervention Training: An Integrated Mixed Reality Approach](https://arxiv.org/abs/2505.10902)
...
### [148] [VISTA: Enhancing Vision-Text Alignment in MLLMs via Cross-Modal Mutual Information Maximization](https://arxiv.org/abs/2505.10917)
...
### [149] [Towards Cross-modal Retrieval in Chinese Cultural Heritage Documents: Dataset and Solution](https://arxiv.org/abs/2505.10921)
...
### [150] [M4-SAR: A Multi-Resolution, Multi-Polarization, Multi-Scene, Multi-Source Dataset and Benchmark for Optical-SAR Fusion Object Detection](https://arxiv.org/abs/2505.10931)
...
### [151] [Visual Anomaly Detection under Complex View-Illumination Interplay: A Large-Scale Benchmark](https://arxiv.org/abs/2505.10996)
...
### [152] [DDAE++: Enhancing Diffusion Models Towards Unified Generative and Discriminative Learning](https://arxiv.org/abs/2505.10999)
...
### [153] [ForensicHub: A Unified Benchmark & Codebase for All-Domain Fake Image Detection and Localization](https://arxiv.org/abs/2505.11003)
...
### [154] [Towards Robust and Controllable Text-to-Motion via Masked Autoregressive Diffusion](https://arxiv.org/abs/2505.11013)
...
### [155] [WildDoc: How Far Are We from Achieving Comprehensive and Robust Document Understanding in the Wild?](https://arxiv.org/abs/2505.11015)
...
### [156] [Rethinking the Mean Teacher Strategy from the Perspective of Self-paced Learning](https://arxiv.org/abs/2505.11018)
...
### [157] [Classifying Shelf Life Quality of Pineapples by Combining Audio and Visual Features](https://arxiv.org/abs/2505.11020)
...
### [158] [CleanPatrick: A Benchmark for Image Data Cleaning](https://arxiv.org/abs/2505.11034)
...
### [159] [Artifacts of Idiosyncracy in Global Street View Data](https://arxiv.org/abs/2505.11046)
...
### [160] [CUBIC: Concept Embeddings for Unsupervised Bias Identification using VLMs](https://arxiv.org/abs/2505.11060)
...
### [161] [HSRMamba: Efficient Wavelet Stripe State Space Model for Hyperspectral Image Super-Resolution](https://arxiv.org/abs/2505.11062)
...
### [162] [Towards Self-Improvement of Diffusion Models via Group Preference Optimization](https://arxiv.org/abs/2505.11070)
...
### [163] [Pseudo-Label Quality Decoupling and Correction for Semi-Supervised Instance Segmentation](https://arxiv.org/abs/2505.11075)
...
### [164] [Hybrid-Emba3D: Geometry-Aware and Cross-Path Feature Hybrid Enhanced State Space Model for Point Cloud Classification](https://arxiv.org/abs/2505.11099)
...
### [165] [MAVOS-DD: Multilingual Audio-Video Open-Set Deepfake Detection Benchmark](https://arxiv.org/abs/2505.11109)
...
### [166] [Deepfake Forensic Analysis: Source Dataset Attribution and Legal Implications of Synthetic Media Manipulation](https://arxiv.org/abs/2505.11110)
...
### [167] [Redundancy-Aware Pretraining of Vision-Language Foundation Models in Remote Sensing](https://arxiv.org/abs/2505.11121)
...
### [168] [PhiNet v2: A Mask-Free Brain-Inspired Vision Foundation Model from Video](https://arxiv.org/abs/2505.11129)
...
### [169] [One Image is Worth a Thousand Words: A Usability Preservable Text-Image Collaborative Erasing Framework](https://arxiv.org/abs/2505.11131)
...
### [170] [Human-Aligned Bench: Fine-Grained Assessment of Reasoning Ability in MLLMs vs. Humans](https://arxiv.org/abs/2505.11141)
...
### [171] [Learning Dense Hand Contact Estimation from Imbalanced Data](https://arxiv.org/abs/2505.11152)
...
### [172] [CheX-DS: Improving Chest X-ray Image Classification with Ensemble Learning Based on DenseNet and Swin Transformer](https://arxiv.org/abs/2505.11168)
...
### [173] [CompAlign: Improving Compositional Text-to-Image Generation with a Complex Benchmark and Fine-Grained Feedback](https://arxiv.org/abs/2505.11178)
...
### [174] [Imputation-free and Alignment-free: Incomplete Multi-view Clustering Driven by Consensus Semantic Learning](https://arxiv.org/abs/2505.11182)
...
### [175] [FALCON: False-Negative Aware Learning of Contrastive Negatives in Vision-Language Pretraining](https://arxiv.org/abs/2505.11192)
...
### [176] [DiCo: Revitalizing ConvNets for Scalable and Efficient Diffusion Modeling](https://arxiv.org/abs/2505.11196)
...
### [177] [GeoMM: On Geodesic Perspective for Multi-modal Learning](https://arxiv.org/abs/2505.11216)
...
### [178] [AW-GATCN: Adaptive Weighted Graph Attention Convolutional Network for Event Camera Data Joint Denoising and Object Recognition](https://arxiv.org/abs/2505.11232)
...
### [179] [Diffusion-NPO: Negative Preference Optimization for Better Preference Aligned Generation of Diffusion Models](https://arxiv.org/abs/2505.11245)
...
### [180] [Entropy-Driven Genetic Optimization for Deep-Feature-Guided Low-Light Image Enhancement](https://arxiv.org/abs/2505.11246)
...
### [181] [DRAGON: A Large-Scale Dataset of Realistic Images Generated by Diffusion Models](https://arxiv.org/abs/2505.11257)
...
### [182] [Multi-view dense image matching with similarity learning and geometry priors](https://arxiv.org/abs/2505.11264)
...
### [183] [Equal is Not Always Fair: A New Perspective on Hyperspectral Representation Non-Uniformity](https://arxiv.org/abs/2505.11267)
...
### [184] [MTevent: A Multi-Task Event Camera Dataset for 6D Pose Estimation and Moving Object Detection](https://arxiv.org/abs/2505.11282)
...
### [185] [Breaking the Batch Barrier (B3) of Contrastive Learning via Smart Batch Mining](https://arxiv.org/abs/2505.11293)
...
### [186] [CROC: Evaluating and Training T2I Metrics with Pseudo- and Human-Labeled Contrastive Robustness Checks](https://arxiv.org/abs/2505.11314)
...
### [187] [Temporally-Grounded Language Generation: A Benchmark for Real-Time Vision-Language Models](https://arxiv.org/abs/2505.11326)
...
### [188] [MARRS: Masked Autoregressive Unit-based Reaction Synthesis](https://arxiv.org/abs/2505.11334)
...
### [189] [Dynamic Base model Shift for Delta Compression](https://arxiv.org/abs/2505.11344)
...
### [190] [EmotionHallucer: Evaluating Emotion Hallucinations in Multimodal Large Language Models](https://arxiv.org/abs/2505.11405)
...
### [191] [Dynam3D: Dynamic Layered 3D Tokens Empower VLM for Vision-and-Language Navigation](https://arxiv.org/abs/2505.11383)
...
### [192] [MutualNeRF: Improve the Performance of NeRF under Limited Samples with Mutual Information Theory](https://arxiv.org/abs/2505.11386)
...
### [193] [Patho-R1: A Multimodal Reinforcement Learning-Based Pathology Expert Reasoner](https://arxiv.org/abs/2505.11404)
...
### [194] [Improving Object Detection Performance through YOLOv8: A Comprehensive Training and Evaluation Study](https://arxiv.org/abs/2505.11424)
...
### [195] [Face Consistency Benchmark for GenAI Video](https://arxiv.org/abs/2505.11425)
...
### [196] [SurgPose: Generalisable Surgical Instrument Pose Estimation using Zero-Shot Learning and Stereo Vision](https://arxiv.org/abs/2505.11439)
...
### [197] [HumaniBench: A Human-Centric Framework for Large Multimodal Models Evaluation](https://arxiv.org/abs/2505.11454)
...
### [198] [PSDiffusion: Harmonized Multi-Layer Image Generation via Layout and Appearance Alignment](https://arxiv.org/abs/2505.11468)
...
### [199] [Unsupervised Detection of Distribution Shift in Inverse Problems using Diffusion Models](https://arxiv.org/abs/2505.11482)
...
### [200] [GIE-Bench: Towards Grounded Evaluation for Text-Guided Image Editing](https://arxiv.org/abs/2505.11493)
...
### [201] [QVGen: Pushing the Limit of Quantized Video Generative Models](https://arxiv.org/abs/2505.11497)
...
### [202] [Robust Emotion Recognition via Bi-Level Self-Supervised Continual Learning](https://arxiv.org/abs/2505.10575)
*Adnan Ahmad,Bahareh Nakisa,Mohammad Naim Rastgoo*

Main category: cs.CV

TL;DR: A novel bi-level self-supervised continual learning framework (SSOCL) is proposed for emotion recognition from EEG data, addressing cross-subject variability and noisy labels in continuous, unlabeled data streams.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with cross-subject variability and noisy labels in continuous, unlabeled physiological data for emotion recognition.

Method: SSOCL uses a dynamic memory buffer, fast adaptation module, and cluster-mapping module to iteratively refine pseudo-labels and retain representative samples.

Result: Outperforms existing approaches in adapting to continuous data streams and generalizing across subjects in EEG tasks.

Conclusion: SSOCL effectively handles evolving data streams and improves emotion recognition performance.
...
### [203] [Bias and Generalizability of Foundation Models across Datasets in Breast Mammography](https://arxiv.org/abs/2505.10579)
*Germani Elodie,Selin Türk Ilayda,Zeineddine Fatima,Mourad Charbel,Albarqouni Shadi*

Main category: cs.CV

TL;DR: The paper examines fairness and bias in foundation models (FMs) for breast mammography classification, highlighting challenges like data variability and biases, and evaluates mitigation strategies.


<details>
  <summary>Details</summary>
Motivation: To address the limited clinical adoption of computer-aided diagnosis tools due to data variability and biases, and to explore the fairness of FMs in breast cancer screening.

Method: Leveraged diverse datasets, including underrepresented regions, to evaluate FM performance. Tested modality-specific pre-training, dataset aggregation, domain-adaptation, and fairness-aware techniques.

Result: Modality-specific pre-training improved performance, but biases persisted. Dataset aggregation helped but didn't fully mitigate disparities. Fairness-aware techniques provided stable, equitable results.
...
### [204] [Relative Drawing Identification Complexity is Invariant to Modality in Vision-Language Models](https://arxiv.org/abs/2505.10583)
*Diogo Freitas,Brigt Håvardstun,Cèsar Ferri,Darío Garigliotti,Jan Arne Telle,José Hernández-Orallo*

Main category: cs.CV

TL;DR: The paper explores whether multimodal language models use common representations for different modalities (e.g., images and text) by evaluating teaching complexity for visual-language models using images and coordinate-based descriptions. Results show image-based teaching is more efficient, but concept simplicity ranks similarly across modalities.


<details>
  <summary>Details</summary>
Motivation: To investigate if multimodal language models integrate modalities using common representations, focusing on whether visual and textual inputs map to similar latent spaces.

Method: Uses machine teaching to evaluate the complexity of teaching visual-language models using images (bitmaps) and coordinate-based descriptions (TikZ format) from the Quick, Draw! dataset.

Result: Image-based representations require fewer teaching segments and achieve higher accuracy than coordinate-based ones, but concept simplicity ranks similarly across modalities.

Conclusion: The simplicity of concepts may be inherent and transcend modality representations, suggesting common underlying structures in multimodal models.
...
### [205] [Aquarius: A Family of Industry-Level Video Generation Models for Marketing Scenarios](https://arxiv.org/abs/2505.10584)
*Huafeng Shi,Jianzhong Liang,Rongchang Xie,Xian Wu,Cheng Chen,Chang Liu*

Main category: cs.CV

TL;DR: Aquarius is a family of industry-level video generation models for marketing, designed for large-scale clusters and models with hundreds of billions of parameters. It excels in high-fidelity, multi-aspect-ratio, and long-duration video synthesis.
...
Method: Aquarius includes a distributed data processing pipeline, scalable model architectures (Single-DiT and Multimodal-DiT), high-performance training infrastructure, parallel inference acceleration, and marketing-scenario applications.

Result: Achieves 36% MFU at scale, 2.35x inference speedup, and supports diverse video generation tasks like text-to-video and video inpainting.

Conclusion: Aquarius sets a benchmark for industrial video generation, with plans for further downstream applications and updates.
...
### [206] [Efficient Malicious UAV Detection Using Autoencoder-TSMamba Integration](https://arxiv.org/abs/2505.10585)
*Azim Akhtarshenas,Ramin Toosi,David López-Pérez,Tohid Alizadeh,Alireza Hosseini*

Main category: cs.CV

TL;DR: The paper proposes an AE-classifier system using a 4-layer TSMamba architecture to detect malicious UAVs, achieving high accuracy (99.8% recall) and reduced computational complexity.


<details>
  <summary>Details</summary>
Motivation: Malicious UAVs threaten next-generation networks with risks like surveillance, data theft, and hazardous material delivery, necessitating robust detection methods.

Method: The system combines an autoencoder (AE) with a ResNet-based classifier, leveraging residual values for lower complexity and higher accuracy.

Result: Experiments show 99.8% recall in binary/multi-class scenarios, outperforming benchmarks (96.7%), with reduced computational complexity.
...
### [207] [Super-Resolution Generative Adversarial Networks based Video Enhancement](https://arxiv.org/abs/2505.10589)
*Kağan ÇETİN*
...
<details>
  <summary>Details</summary>
Motivation: SRGAN is effective for single-image super-resolution but lacks temporal continuity for videos. This work aims to adapt it for video processing.

Method: A modified SRGAN framework with 3D Non-Local Blocks is proposed, along with patch-wise learning and advanced data degradation techniques. Two model variants (large and lightweight) are tested.

Result: The approach shows improved temporal coherence, sharper textures, and fewer artifacts compared to single-image methods.

Conclusion: This work advances learning-based video enhancement, with applications in streaming, gaming, and digital restoration.
...
### [208] [ARFC-WAHNet: Adaptive Receptive Field Convolution and Wavelet-Attentive Hierarchical Network for Infrared Small Target Detection](https://arxiv.org/abs/2505.10595)
*Xingye Cui,Junhai Luo,Jiakun Deng,Kexuan Li,Xiangyu Qiu,Zhenming Peng*

Main category: cs.CV

TL;DR: The paper proposes ARFC-WAHNet, a novel network for infrared small target detection, addressing limitations of current methods with adaptive receptive field convolution and wavelet-attentive modules, achieving superior performance on public datasets.


<details>
  <summary>Details</summary>
Motivation: Infrared small target detection is challenging due to limited texture and structural information in images. Existing deep learning methods suffer from feature loss and poor adaptability to complex scenes.

Method: ARFC-WAHNet includes MRFFIConv for adaptive feature extraction, WFED for wavelet-based feature enhancement, HLFF for feature fusion, and GMEA for global attention.

Result: The method outperforms state-of-the-art approaches on SIRST, NUDT-SIRST, and IRSTD-1k datasets, especially in complex backgrounds.

Conclusion: ARFC-WAHNet effectively addresses feature loss and adaptability issues, demonstrating superior detection accuracy and robustness.
...
### [209] [SRMamba: Mamba for Super-Resolution of LiDAR Point Clouds](https://arxiv.org/abs/2505.10601)
*Chuang Chen,Wenyi Ge*
...
<details>
  <summary>Details</summary>
Motivation: The sparsity and irregular structure of LiDAR point clouds make super-resolution challenging, particularly for novel views. Existing methods struggle with recovering 3D spatial structure.
...
### [210] [MIRAGE: A Multi-modal Benchmark for Spatial Perception, Reasoning, and Intelligence](https://arxiv.org/abs/2505.10604)
*Chonghan Liu,Haoran Wang,Felix Henry,Pu Miao,Yajie Zhang,Yu Zhao,Peiran Wu*

Main category: cs.CV

TL;DR: MIRAGE is a multi-modal benchmark evaluating models' abilities in object attribute recognition and spatial relational reasoning, revealing gaps in current models.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks show gaps in models' abilities for object attribute recognition and spatial reasoning, essential for dynamic reasoning.
...
Result: Highlights limitations in state-of-the-art models, emphasizing the need for better representations and reasoning frameworks.
...
### [211] [MMLongBench: Benchmarking Long-Context Vision-Language Models Effectively and Thoroughly](https://arxiv.org/abs/2505.10610)
*Zhaowei Wang,Wenhao Yu,Xiyu Ren,Jipeng Zhang,Yu Zhao,Rohit Saxena,Liang Cheng,Ginny Wong,Simon See,Pasquale Minervini,Yangqiu Song,Mark Steedman*

Main category: cs.CV

TL;DR: MMLongBench is introduced as the first benchmark for evaluating long-context vision-language models (LCVLMs) across diverse tasks, image types, and input lengths, revealing gaps in current models' capabilities.


<details>
  <summary>Details</summary>
Motivation: To address the lack of a comprehensive benchmark for assessing LCVLMs' performance on long-context vision-language tasks.

Method: Developed MMLongBench with 13,331 examples across five task categories, standardized input lengths (8K-128K tokens), and diverse image types. Evaluated 46 LCVLMs.

Result: Found that single-task performance is a poor indicator of overall capability, both closed and open-source models struggle, and reasoning ability correlates with long-context performance.

Conclusion: MMLongBench fills a critical gap, enabling better diagnosis and advancement of LCVLMs.
...
### [212] [Mitigate Language Priors in Large Vision-Language Models by Cross-Images Contrastive Decoding](https://arxiv.org/abs/2505.10634)
*Jianfei Zhao,Feng Zhang,Xin Sun,Chong Feng*

Main category: cs.CV

TL;DR: The paper introduces Cross-Image Contrastive Decoding (CICD), a training-free method to reduce language priors in Large Vision-Language Models (LVLMs), improving visual consistency without sacrificing fluency.


<details>
  <summary>Details</summary>
Motivation: Language priors in LVLMs cause hallucinations by favoring linguistically plausible but visually inconsistent outputs, a problem rooted in their LLM backbone.
...
Result: CICD effectively reduces language priors, particularly in image captioning, as validated on four benchmarks with six LVLMs.

Conclusion: CICD is a simple, effective solution to mitigate language priors in LVLMs, enhancing visual-textual alignment without additional training.
...
### [213] [Advancing Multiple Instance Learning with Continual Learning for Whole Slide Imaging](https://arxiv.org/abs/2505.10649)
*Xianrui Li,Yufei Cui,Jun Li,Antoni B. Chan*

Main category: cs.CV

TL;DR: The paper proposes Attention Knowledge Distillation (AKD) and Pseudo-Bag Memory Pool (PMP) to improve continual learning (CL) in attention-based MIL models for WSI analysis, addressing catastrophic forgetting and memory efficiency.


<details>
  <summary>Details</summary>
Motivation: Conventional MIL models lack adaptability to evolving datasets, and CL applied to MIL often shows limited improvements due to forgetting in attention layers.

Method: Analyzes CL in attention MIL models, identifies forgetting in attention layers, and introduces AKD to retain attention knowledge and PMP to reduce memory usage by storing informative pseudo-bags.

Result: The method improves accuracy and memory efficiency on WSI datasets, outperforming state-of-the-art CL methods.

Conclusion: This work enhances CL for MIL models, enabling more adaptable and resilient diagnostic tools for large-scale clinical datasets.
...
### [214] [CLIP Embeddings for AI-Generated Image Detection: A Few-Shot Study with Lightweight Classifier](https://arxiv.org/abs/2505.10664)
*Ziyang Ou*

Main category: cs.CV

TL;DR: The paper explores using CLIP embeddings to classify AI-generated images, achieving 95% accuracy on CIFAKE and 85% with few-shot adaptation. Challenges remain for specific image types.


<details>
  <summary>Details</summary>
Motivation: The rise of AI-generated images on social media necessitates methods to verify authenticity, but VLMs like CLIP lack pre-training labels for such tasks.

Method: A pipeline extracts CLIP embeddings, feeds them to lightweight networks, and fine-tunes the classifier. Evaluated on CIFAKE and custom datasets.

Result: 95% accuracy on CIFAKE, 85% with few-shot adaptation. Gemini-2.0 excels in zero-shot but struggles with specific styles. Wide-angle photos and oil paintings are challenging.

Conclusion: CLIP embeddings show promise for AI-image classification, but certain image types remain difficult, highlighting new research directions.
...
### [215] [GA3CE: Unconstrained 3D Gaze Estimation with Gaze-Aware 3D Context Encoding](https://arxiv.org/abs/2505.10671)
*Yuki Kawana,Shintaro Shiba,Quan Kong,Norimasa Kobori*

Main category: cs.CV

TL;DR: A novel 3D gaze estimation method, GA3CE, improves accuracy by learning spatial relationships in 3D space, reducing error by 13%-37%.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with unconstrained settings (e.g., distant subjects) due to reliance on 2D appearance or limited spatial cues.

Method: GA3CE uses 3D poses and object positions as context, aligned in egocentric space, and introduces D$^3$ positional encoding for spatial relationships.

Result: Substantial improvement, reducing mean angle error by 13%-37% over baselines.

Conclusion: GA3CE effectively addresses challenges in 3D gaze estimation by leveraging 3D spatial relationships.
...
### [216] [Are Spatial-Temporal Graph Convolution Networks for Human Action Recognition Over-Parameterized?](https://arxiv.org/abs/2505.10679)
*Jianyang Xie,Yitian Zhao,Yanda Meng,He Zhao,Anh Nguyen,Yalin Zheng*

Main category: cs.CV

TL;DR: The paper explores over-parameterization in ST-GCNs for HAR, proposes a sparse ST-GCNs generator, and demonstrates improved performance with multi-level sparsity.


<details>
  <summary>Details</summary>
Motivation: Existing ST-GCNs for HAR are over-parameterized, with minimal performance differences despite varied models.

Method: Proposes a sparse ST-GCNs generator and integrates multi-level sparsity structures.

Result: Sparse ST-GCNs achieve comparable performance with 95% fewer parameters, while multi-level sparsity improves accuracy by >1% with 66% parameters.

Conclusion: The study confirms over-parameterization in ST-GCNs and shows sparse architectures can maintain or enhance HAR performance.
...
### [217] [GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention](https://arxiv.org/abs/2505.10685)
*Lingjun Zhao,Sizhe Wei,James Hays,Lu Gan*

Main category: cs.CV

TL;DR: A multi-modal Gaussian-based semantic occupancy prediction framework, GaussianFormer3D, is proposed for autonomous driving, using LiDAR-camera fusion and 3D deformable attention for improved accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: 3D semantic occupancy prediction is crucial for autonomous driving, and multi-modal methods (LiDAR-camera fusion) outperform camera-only systems. Existing grid-based representations are limited, while 3D Gaussians offer a compact, continuous alternative.

Method: GaussianFormer3D uses a voxel-to-Gaussian initialization for geometry priors from LiDAR and a LiDAR-guided 3D deformable attention mechanism to refine 3D Gaussians with fusion features.

Result: Experiments show GaussianFormer3D achieves high accuracy comparable to state-of-the-art methods, with reduced memory and improved efficiency.

Conclusion: The proposed framework effectively leverages 3D Gaussians and multi-modal fusion for accurate and efficient 3D semantic occupancy prediction.
...
### [218] [Automated Detection of Salvin's Albatrosses: Improving Deep Learning Tools for Aerial Wildlife Surveys](https://arxiv.org/abs/2505.10737)
*Mitchell Rogers,Theo Thompson,Isla Duporge,Johannes Fischer,Klemens Pütz,Thomas Mattern,Bing Xue,Mengjie Zhang*

Main category: cs.CV

TL;DR: The study evaluates BirdDetector, a deep-learning model, for monitoring Salvin's albatross populations using UAV imagery, showing improved accuracy with fine-tuning and augmentation.


<details>
  <summary>Details</summary>
Motivation: To assess the effectiveness of a general-purpose avian detection model for species-specific wildlife monitoring in remote areas using cost-effective UAV imagery.

Method: The study tests BirdDetector in zero-shot and fine-tuned settings with drone-derived imagery, using enhanced inference and stronger augmentation techniques.

Result: Fine-tuning with target-domain annotations and stronger augmentation significantly improves detection accuracy compared to zero-shot performance.
...
### [219] [IMAGE-ALCHEMY: Advancing subject fidelity in personalised text-to-image generation](https://arxiv.org/abs/2505.10743)
*Amritanshu Tiwari,Cherish Puniani,Kaustubh Sharma,Ojasva Nema*

Main category: cs.CV

TL;DR: A two-stage pipeline using LoRA-based fine-tuning on SDXL addresses challenges in personalizing text-to-image models, achieving high fidelity and outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Personalizing text-to-image models like Stable Diffusion for novel subjects often leads to issues like catastrophic forgetting or overfitting, which this work aims to resolve.

Method: The method involves a two-stage pipeline: first generating a generic scene with SDXL, then inserting the personalized subject via a segmentation-driven Img2Img pipeline using trained LoRA weights.

Result: The approach achieves a DINO similarity score of 0.789 on SDXL, outperforming existing personalized text-to-image methods.

Conclusion: The proposed framework effectively isolates subject encoding from composition, preserving SDXL's generative capabilities while integrating new subjects with high fidelity.
...
### [220] [Mapping Semantic Segmentation to Point Clouds Using Structure from Motion for Forest Analysis](https://arxiv.org/abs/2505.10751)
*Francisco Raverta Capua,Pablo De Cristoforis*

Main category: cs.CV

TL;DR: A novel pipeline for generating semantically segmented point clouds of forests using a custom simulator and modified SfM software, addressing the lack of public annotated datasets.


<details>
  <summary>Details</summary>
Motivation: Public annotated point cloud datasets for forests are scarce due to high costs and technical challenges, especially with SfM algorithms preserving semantic information.

Method: Uses a custom forest simulator to generate labeled RGB images, processed by modified SfM software to retain semantic details in 3D reconstruction.

Result: Produces point clouds with geometric and semantic detail, useful for training deep learning models for real forest segmentation.

Conclusion: The pipeline offers a valuable resource for advancing forest monitoring and segmentation tasks using SfM-derived point clouds.
...
### [221] [Benchmarking performance, explainability, and evaluation strategies of vision-language models for surgery: Challenges and opportunities](https://arxiv.org/abs/2505.10764)
*Jiajun Cheng,Xianwu Zhao,Shan Lin*
...
<details>
  <summary>Details</summary>
Motivation: To assess the performance of general-purpose VLMs in the surgical domain, given their success in other visual tasks.

Method: Benchmarking several VLMs across diverse surgical datasets, including laparoscopic procedures and endoscopic submucosal dissection.

Result: VLMs show limitations in consistently linking language to correct regions in surgical scenes.

Conclusion: General-purpose VLMs have potential but require improvements for surgical domain applications.
...
### [222] [Unifying Segment Anything in Microscopy with Multimodal Large Language Model](https://arxiv.org/abs/2505.10769)
*Manyu Li,Ruian He,Zixian Zhang,Weimin Tan,Bo Yan*

Main category: cs.CV

TL;DR: The paper introduces uLLSAM, a method leveraging Multimodal Large Language Models (MLLMs) to enhance the Segment Anything Model (SAM) for biomedical image segmentation by injecting Vision-Language Knowledge (VLK), improving cross-domain generalization.


<details>
  <summary>Details</summary>
Motivation: Existing biomedical segmentation models underperform on unseen domain data due to lack of vision-language knowledge. MLLMs' multimodal understanding capabilities inspire their use to enhance SAM.

Method: Proposes uLLSAM with Vision-Language Semantic Alignment (VLSA) to inject VLK into SAM and Semantic Boundary Regularization (SBR) to address boundary perception issues.

Result: Achieves 7.71% Dice and 12.10% SA improvements on in-domain datasets, and 6.79% Dice and 10.08% SA improvements on out-of-domain datasets.

Conclusion: uLLSAM significantly enhances SAM's performance and generalization, demonstrating the value of integrating vision-language knowledge for biomedical segmentation.
...
### [223] [Completely Weakly Supervised Class-Incremental Learning for Semantic Segmentation](https://arxiv.org/abs/2505.10781)
*David Minkwan Kim,Soeun Lee,Byeongkeun Kang*

Main category: cs.CV

TL;DR: The paper introduces a completely weakly supervised method for class-incremental semantic segmentation (CISS) using only image-level labels, outperforming partially supervised methods in some settings.


<details>
  <summary>Details</summary>
Motivation: Traditional CISS methods require costly pixel-level annotations, and existing weakly-supervised approaches are only partial. This work aims to eliminate the need for pixel-level labels entirely.

Method: The method generates robust pseudo-labels by combining outputs from a localizer and foundation models based on uncertainty. It also uses exemplar-guided data augmentation to prevent catastrophic forgetting.

Result: The method outperforms partially weakly supervised methods in 15-5 VOC and 10-10 VOC settings and achieves competitive accuracy in COCO-to-VOC.

Conclusion: The proposed completely weakly supervised approach is effective for CISS, reducing annotation costs while maintaining performance.
...
### [224] [SynRailObs: A Synthetic Dataset for Obstacle Detection in Railway Scenarios](https://arxiv.org/abs/2505.10784)
*Qiushi Guo,Jason Rambach*
...
<details>
  <summary>Details</summary>
Motivation: Existing datasets lack diversity and precision for railway obstacle detection, limiting research progress. SynRailObs aims to fill this gap with high-quality synthetic data.

Method: The dataset uses diffusion models to generate rare obstacles and includes diverse weather and geographical conditions. Real-world experiments validate its effectiveness.

Result: Models trained on SynRailOps perform consistently across distances and conditions, with zero-shot capabilities for security-sensitive applications.

Conclusion: SynRailObs advances railway safety research by providing a robust synthetic dataset, demonstrating practical utility in real-world scenarios.
...
### [225] [EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes](https://arxiv.org/abs/2505.10787)
*Jianlin Guo,Haihong Xiao,Wenxiong Kang*

Main category: cs.CV

TL;DR: EA-3DGS improves outdoor scene rendering by combining adaptive tetrahedral mesh initialization, efficient Gaussian pruning, and structure-aware densification, achieving high-quality real-time performance with reduced memory usage.


<details>
  <summary>Details</summary>
Motivation: Current NeRF-based methods are slow for large-scale scenes, and 3D Gaussian Splatting (3DGS) struggles with memory constraints and lacks adjustment mechanisms for outdoor scenes.

Method: EA-3DGS uses an adaptive tetrahedral mesh for Gaussian initialization, a pruning strategy for efficiency, densification for geometry retention, and vector quantization for parameter compression.

Result: The method outperforms on 13 scenes, including public datasets and self-collected UAV data, showing superior rendering quality and speed.

Conclusion: EA-3DGS addresses key limitations of existing methods, offering a practical solution for high-quality, real-time outdoor scene rendering.
...
### [226] [MoCLIP: Motion-Aware Fine-Tuning and Distillation of CLIP for Human Motion Generation](https://arxiv.org/abs/2505.10810)
*Gabriel Maldonado,Armin Danesh Pazho,Ghazal Alinezhad Noghre,Vinit Katariya,Hamed Tabkhi*
...
<details>
  <summary>Details</summary>
Motivation: Existing CLIP-based text encoders lack understanding of temporal and kinematic motion structures, limiting their effectiveness in motion generation.
...
### [227] [From Embeddings to Accuracy: Comparing Foundation Models for Radiographic Classification](https://arxiv.org/abs/2505.10823)
*Xue Li,Jameson Merkow,Noel C. F. Codella,Alberto Santamaria-Pang,Naiteek Sangani,Alexander Ersoy,Christopher Burt,John W. Garrett,Richard J. Bruce,Joshua D. Warner,Tyler Bradshaw,Ivan Tarapov,Matthew P. Lungren,Alan B. McMillan*

Main category: cs.CV

TL;DR: The study evaluates foundation model embeddings for lightweight adapter models in radiography classification, finding MedImageInsight with SVM as the top performer (93.8% mAUC), with efficient and fair results.


<details>
  <summary>Details</summary>
Motivation: To assess the utility of general and medical-specific foundation model embeddings for training lightweight adapters in multi-class radiography classification, focusing on tube placement.

Method: Used 8842 radiographs to extract embeddings from six foundation models, trained adapter models with classical ML algorithms, and evaluated performance (mAUC), efficiency, and fairness.

Result: MedImageInsight with SVM achieved the highest mAUC (93.8%). Most adapters were computationally efficient (training <1 min, inference in seconds) and fair (gender differences <2%, age group SD <3%).

Conclusion: Foundation model embeddings, especially MedImageInsight, enable accurate, efficient, and equitable diagnostic classification in radiography.
...
### [228] [A High-Performance Thermal Infrared Object Detection Framework with Centralized Regulation](https://arxiv.org/abs/2505.10825)
*Jinke Li,Yue Wu,Xiaoyan Yang*

Main category: cs.CV

TL;DR: The paper introduces CRT-YOLO, a novel TIR object detection framework with centralized feature regulation and EMA modules, outperforming traditional methods.


<details>
  <summary>Details</summary>
Motivation: Traditional TIR object detection methods fail to effectively extract and fuse local-global information, limiting feature attention.
...
### [229] [NeuSEditor: From Multi-View Images to Text-Guided Neural Surface Edits](https://arxiv.org/abs/2505.10827)
*Nail Ibrahimli,Julian F. P. Kooij,Liangliang Nan*

Main category: cs.CV

TL;DR: NeuSEditor is a novel method for text-guided editing of neural implicit surfaces, preserving identity and geometric consistency while simplifying the workflow.


<details>
  <summary>Details</summary>
Motivation: Existing methods for editing implicit surfaces struggle with preserving identity and geometric consistency, prompting the need for a better solution.

Method: NeuSEditor uses an identity-preserving architecture to separate scenes into foreground and background, along with a geometry-aware distillation loss for improved rendering and geometry.

Result: NeuSEditor outperforms state-of-the-art methods like PDS and InstructNeRF2NeRF, delivering superior results.

Conclusion: NeuSEditor effectively addresses editing challenges for neural implicit surfaces, offering a robust and efficient solution.
...
### [230] [RefPose: Leveraging Reference Geometric Correspondences for Accurate 6D Pose Estimation of Unseen Objects](https://arxiv.org/abs/2505.10841)
*Jaeguk Kim,Jaewoo Park,Keuntek Lee,Nam Ik Cho*

Main category: cs.CV

TL;DR: RefPose is a novel method for 6D pose estimation of unseen objects using reference images and geometric correspondence, outperforming traditional approaches.


<details>
  <summary>Details</summary>
Motivation: The challenge of estimating 6D poses of unseen objects from monocular RGB images due to lack of prior object-specific knowledge.

Method: RefPose predicts an initial pose using object templates, refines it via render-and-compare, and employs a correlation volume-guided attention mechanism.

Result: Achieves state-of-the-art performance on BOP benchmark datasets with competitive runtime.

Conclusion: RefPose dynamically adapts to new objects, offering robust and efficient pose estimation without pre-defined models.
...
### [231] [A Convolution-Based Gait Asymmetry Metric for Inter-Limb Synergistic Coordination](https://arxiv.org/abs/2505.10869)
*Go Fukino,Kanta Tachibana*

Main category: cs.CV

TL;DR: The paper proposes a method to evaluate gait symmetry using an LTI system and a dissimilarity metric, tested on subjects with symmetric and asymmetric gait.
...
Method: Models intersegmental coordination with an LTI system and introduces a dissimilarity metric for symmetry evaluation.

Result: Tested on five subjects, the method effectively distinguishes between symmetric and asymmetric gait.

Conclusion: The proposed method offers a novel approach to gait symmetry analysis, improving upon traditional techniques.
...
### [232] [A Light and Smart Wearable Platform with Multimodal Foundation Model for Enhanced Spatial Reasoning in People with Blindness and Low Vision](https://arxiv.org/abs/2505.10875)
*Alexey Magay,Dhurba Tripathi,Yu Hao,Yi Fang*

Main category: cs.CV

TL;DR: The paper proposes a spatial-enhanced multi-modal large language model (MLLM) for visually impaired individuals, integrating spatial reasoning and a hardware attachment for real-time feedback, improving navigation and object recognition.


<details>
  <summary>Details</summary>
Motivation: Current MLLMs lack spatial reasoning for pBLV, and there's a need for lightweight, user-friendly systems to assist in environmental interaction.

Method: Fine-tune MLLM for spatial reasoning, integrate with a glasses-attached hardware component, and use VLMs for real-time feedback.

Result: Substantial improvements in accuracy and user experience, validated using VizWiz and a custom dataset.
...
### [233] [PoseBench3D: A Cross-Dataset Analysis Framework for 3D Human Pose Estimation](https://arxiv.org/abs/2505.10888)
*Saad Manzur,Bryan Vela,Brandon Vela,Aditya Agrawal,Lan-Anh Dang-Vu,David Li,Wayne Hayes*
...
<details>
  <summary>Details</summary>
Motivation: Prior work lacks adaptability to diverse real-world conditions, necessitating a unified evaluation framework.

Method: Proposes PoseBench3D, a framework for cross-dataset evaluation, re-evaluating 18 methods using MPJPE and PA-MPJPE metrics.

Result: Generated over 100 novel cross-dataset results, analyzing performance differences due to pre-processing and dataset parameters.

Conclusion: PoseBench3D enables systematic evaluation and insights into model generalization, supporting future advancements in the field.
...
### [234] [Patient-Specific Dynamic Digital-Physical Twin for Coronary Intervention Training: An Integrated Mixed Reality Approach](https://arxiv.org/abs/2505.10902)
*Shuo Wang,Tong Ren,Nan Cheng,Rong Wang,Li Zhang*

Main category: cs.CV

TL;DR: A dynamic cardiac model framework using 4D-CTA and digital twin technology was developed for precise, personalized coronary intervention training and planning.


<details>
  <summary>Details</summary>
Motivation: Existing training systems lack accurate simulation of cardiac dynamics, necessitating a more comprehensive approach.

Method: The study used 4D-CTA data to segment cardiac structures, simulate vessel deformation, and manufacture transparent vascular models. Virtual angiography and guidewire reconstruction were also implemented.

Result: Morphological consistency was 80.9%, with guidewire motion accuracy (Dice 0.741-0.812) and mean trajectory errors <1.1 mm. The transparent model aided CABG training.

Conclusion: The digital-physical twin approach effectively replicates coronary anatomy and dynamics, providing valuable visual and tactile feedback for clinical and educational use.
...
### [235] [VISTA: Enhancing Vision-Text Alignment in MLLMs via Cross-Modal Mutual Information Maximization](https://arxiv.org/abs/2505.10917)
*Mingxiao Li,Na Su,Fang Qu,Zhizhou Zhong,Ziyang Chen,Zhaopeng Tu,Xiaolong Li*

Main category: cs.CV

TL;DR: The paper addresses modality alignment bias in MLLMs, proposing VISTA, a method to enhance cross-modal alignment without extra modules or data.


<details>
  <summary>Details</summary>
Motivation: MLLMs often favor text over other modalities, degrading cross-modal alignment.

Method: Theoretical analysis of cross-entropy loss reveals limitations; VISTA introduces an explicit alignment objective to maximize mutual information.

Result: VISTA outperforms baselines on multiple benchmarks (e.g., VQAv2, MMStar, MME).

Conclusion: VISTA improves MLLM visual understanding efficiently, advancing multimodal alignment research.
...
### [236] [Towards Cross-modal Retrieval in Chinese Cultural Heritage Documents: Dataset and Solution](https://arxiv.org/abs/2505.10921)
*Junyi Yuan,Jian Zhang,Fangyu Wu,Dongming Lu,Huanda Lu,Qiufeng Wang*
...
<details>
  <summary>Details</summary>
Motivation: Addressing the lack of specialized datasets for Chinese cultural heritage, which limits cross-modal learning model development.

Method: Proposes CulTi dataset (5,726 image-text pairs) and LACLIP, a local alignment strategy based on Chinese-CLIP.

Result: LACLIP significantly improves cross-modal retrieval, especially for fine-grained semantic associations.

Conclusion: CulTi and LACLIP advance cross-modal retrieval in Chinese cultural heritage, addressing dataset and alignment challenges.
...
### [237] [M4-SAR: A Multi-Resolution, Multi-Polarization, Multi-Scene, Multi-Source Dataset and Benchmark for Optical-SAR Fusion Object Detection](https://arxiv.org/abs/2505.10931)
*Chao Wang,Wei Lu,Xiang Li,Jian Yang,Lei Luo*

Main category: cs.CV

TL;DR: The paper introduces M4-SAR, a large-scale dataset for optical-SAR fusion object detection, and proposes E2E-OSDet, a novel framework to improve detection accuracy by leveraging complementary advantages of optical and SAR images.


<details>
  <summary>Details</summary>
Motivation: Single-source remote sensing (optical or SAR) struggles in complex environments due to limitations like weather effects or noise. Combining both can enhance accuracy, but lacks standardized datasets.

Method: The authors create M4-SAR, a dataset with 112,184 aligned optical-SAR pairs and nearly one million labeled instances. They also propose E2E-OSDet, an end-to-end fusion framework, and benchmark six state-of-the-art methods.

Result: Fusing optical and SAR data improves mAP by 5.7% over single-source inputs, especially in complex environments.

Conclusion: M4-SAR and E2E-OSDet provide a robust baseline for optical-SAR fusion research, with publicly available dataset and code.
...
### [238] [Visual Anomaly Detection under Complex View-Illumination Interplay: A Large-Scale Benchmark](https://arxiv.org/abs/2505.10996)
*Yunkang Cao,Yuqi Cheng,Xiaohao Xu,Yiheng Zhang,Yihan Sun,Yuxiang Tan,Yuxin Zhang,Xiaonan Huang,Weiming Shen*

Main category: cs.CV

TL;DR: The paper introduces M2AD, a benchmark for Visual Anomaly Detection (VAD) to address sensitivity to viewpoint and illumination variations, showing current methods struggle with these challenges.


<details>
  <summary>Details</summary>
Motivation: Current VAD systems are hindered by their sensitivity to real-world imaging variations like viewpoint and illumination, which are overlooked in existing benchmarks.

Method: The authors create M2AD, a large-scale benchmark with 119,880 images, systematically capturing 999 specimens across 10 categories under 120 view-illumination configurations. Two evaluation protocols (M2AD-Synergy and M2AD-Invariant) are introduced.

Result: State-of-the-art VAD methods perform poorly on M2AD, highlighting the challenge of view-illumination interplay.

Conclusion: M2AD is a critical tool for developing robust VAD methods, and the dataset will be publicly released to advance the field.
...
### [239] [DDAE++: Enhancing Diffusion Models Towards Unified Generative and Discriminative Learning](https://arxiv.org/abs/2505.10999)
*Weilai Xiang,Hongyu Yang,Di Huang,Yunhong Wang*

Main category: cs.CV

TL;DR: The paper introduces self-conditioning in diffusion models to improve both generative and discriminative performance with minimal computational overhead.


<details>
  <summary>Details</summary>
Motivation: To address whether diffusion models' representations can enhance their own training and rival self-supervised learners without losing generative quality.
...
Result: Boosts generation FID and recognition accuracy with 1% overhead; outperforms self-supervised models in linear evaluations.
...
### [240] [ForensicHub: A Unified Benchmark & Codebase for All-Domain Fake Image Detection and Localization](https://arxiv.org/abs/2505.11003)
*Bo Du,Xuekang Zhu,Xiaochen Ma,Chenfan Qu,Kaiwen Feng,Zhe Yang,Chi-Man Pun,Jian Liu,Jizhe Zhou*

Main category: cs.CV

TL;DR: ForensicHub is a unified benchmark and codebase for Fake Image Detection and Localization (FIDL), addressing fragmentation across four domains by modular design, baseline implementations, and cross-domain analysis.


<details>
  <summary>Details</summary>
Motivation: The FIDL field is fragmented into four domains with no unified benchmark, leading to silos and hindering progress. ForensicHub aims to bridge this gap.
...
Result: The platform enables flexible composition across domains, provides 8 actionable insights, and fosters interoperability and cross-domain comparisons.
...
### [241] [Towards Robust and Controllable Text-to-Motion via Masked Autoregressive Diffusion](https://arxiv.org/abs/2505.11013)
*Zongye Zhang,Bohan Kong,Qingjie Liu,Yunhong Wang*
...
Conclusion: MoMADiff addresses limitations of existing methods, providing robust and controllable motion generation.
...
### [242] [WildDoc: How Far Are We from Achieving Comprehensive and Robust Document Understanding in the Wild?](https://arxiv.org/abs/2505.11015)
*An-Lan Wang,Jingqun Tang,Liao Lei,Hao Feng,Qi Liu,Xiang Fei,Jinghui Lu,Han Wang,Weiwei Liu,Hao Liu,Yuliang Liu,Xiang Bai,Can Huang*

Main category: cs.CV

TL;DR: WildDoc is a new benchmark for evaluating document understanding in natural environments, addressing gaps in existing benchmarks like DocVQA and ChartQA by including real-world challenges such as variable illumination and physical distortions.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks focus on scanned or digital documents, failing to represent real-world complexities. WildDoc aims to bridge this gap by introducing diverse, manually captured document images under varying conditions.

Method: WildDoc includes a diverse set of document images captured in natural environments, with each document captured four times under different conditions to test robustness. It leverages document sources from established benchmarks for comparison.

Result: Evaluations show state-of-the-art MLLMs perform significantly worse on WildDoc, revealing their lack of robustness in real-world scenarios compared to traditional benchmarks.

Conclusion: WildDoc highlights the challenges of real-world document understanding and the need for more robust models, providing a valuable resource for future research.
...
### [243] [Rethinking the Mean Teacher Strategy from the Perspective of Self-paced Learning](https://arxiv.org/abs/2505.11018)
*Pengchen Zhang,Alan J. X. Guo,Sipin Luo,Zhe Han,Lin Guo*

Main category: cs.CV

TL;DR: The paper proposes a dual teacher-student learning (DTSL) framework for semi-supervised medical image segmentation, leveraging cross-architectural models and a consensus label generator to improve performance.


<details>
  <summary>Details</summary>
Motivation: To reduce manual annotation costs in medical image segmentation by enhancing semi-supervised learning methods, particularly the mean teacher strategy.

Method: Introduces DTSL with two teacher-student model groups of different architectures, using output agreement and a Jensen-Shannon divergence-based consensus label generator for pseudo-labels.

Result: Outperforms state-of-the-art methods on popular datasets, with ablation studies confirming the effectiveness of the proposed modules.

Conclusion: DTSL offers a flexible and effective approach for semi-supervised medical image segmentation, validated by superior performance and module efficacy.
...
### [244] [Classifying Shelf Life Quality of Pineapples by Combining Audio and Visual Features](https://arxiv.org/abs/2505.11020)
*Yi-Lu Jiang,Wen-Chang Chang,Ching-Lin Wang,Kung-Liang Hsu,Chih-Yi Chiu*
...
Method: Constructed a multimodal model using audio and visual data from the PQC500 dataset, employing a contrastive audiovisual masked autoencoder and efficient training data sampling.

Result: The cross-modal model achieved 84% accuracy, outperforming unimodal audio (78%) and visual (66%) models.

Conclusion: The proposed method effectively classifies pineapple quality, demonstrating the advantage of multimodal approaches.
...
### [245] [CleanPatrick: A Benchmark for Image Data Cleaning](https://arxiv.org/abs/2505.11034)
*Fabian Gröger,Simone Lionetti,Philippe Gottfrois,Alvaro Gonzalez-Jimenez,Ludovic Amruthalingam,Elisabeth Victoria Goessinger,Hanna Lindemann,Marie Bargiela,Marie Hofbauer,Omar Badri,Philipp Tschandl,Arash Koochek,Matthew Groh,Alexander A. Navarini,Marc Pouly*

Main category: cs.CV

TL;DR: CleanPatrick is a large-scale benchmark for image data cleaning, using the Fitzpatrick17k dataset with human annotations and expert review to identify issues like off-topic samples, near-duplicates, and label errors. It evaluates various methods, showing strengths in self-supervised representations for duplicates and classical methods for off-topic detection, while label-error detection remains challenging.
...
Method: CleanPatrick uses the Fitzpatrick17k dataset, collects 496,377 binary annotations from 933 medical crowd workers, and employs an aggregation model inspired by item-response theory followed by expert review to derive high-quality ground truth. It formalizes issue detection as a ranking task.

Result: Self-supervised representations excel at near-duplicate detection, classical methods perform well for off-topic detection under constrained budgets, and label-error detection remains challenging for fine-grained medical classification.
...
### [246] [Artifacts of Idiosyncracy in Global Street View Data](https://arxiv.org/abs/2505.11046)
*Tim Alpherts,Sennay Ghebreab,Nanne van Noord*

Main category: cs.CV

TL;DR: The paper highlights biases in street view data due to city idiosyncrasies, proposes a method to evaluate coverage distributions, and includes a case study on Amsterdam to address biases.


<details>
  <summary>Details</summary>
Motivation: Street view data is assumed to systematically represent cities, but prior work shows gaps in coverage. This paper investigates how city-specific traits introduce biases even in densely sampled data.

Method: The study quantitatively analyzes biases in street view coverage for 28 global cities and proposes an evaluation method. A case study of Amsterdam with semi-structured interviews explores biases in data collection.

Result: Biases in street view data are uncovered, linked to city layouts and collection processes. The proposed method provides insights into coverage idiosyncrasies.

Conclusion: City-specific traits and collection processes introduce biases in street view data. Addressing these biases at the source can improve representation.
...
### [247] [CUBIC: Concept Embeddings for Unsupervised Bias Identification using VLMs](https://arxiv.org/abs/2505.11060)
*David Méndez,Gianpaolo Bontempo,Elisa Ficarra,Roberto Confalonieri,Natalia Díaz-Rodríguez*

Main category: cs.CV

TL;DR: CUBIC is a novel method for unsupervised bias identification in deep vision models, leveraging image-text latent space and classifier probes to discover interpretable biases without predefined candidates or labeled data.


<details>
  <summary>Details</summary>
Motivation: Deep vision models often learn spurious correlations from datasets, but identifying these biases is challenging due to the lack of annotated concepts.

Method: CUBIC uses image-text latent space and linear classifier probes to measure how concepts influence the latent representation of a superclass label, identifying biases by shifts against the classifier's decision boundary.

Result: CUBIC effectively uncovers unknown biases in Vision-Language Models without requiring labeled bias examples or prior knowledge.

Conclusion: CUBIC provides a scalable, unsupervised solution for bias identification in deep vision models, reducing reliance on labor-intensive annotations.
...
### [248] [HSRMamba: Efficient Wavelet Stripe State Space Model for Hyperspectral Image Super-Resolution](https://arxiv.org/abs/2505.11062)
*Baisong Li,Xingwang Wang,Haixiao Xu*

Main category: cs.CV

TL;DR: HSRMamba improves hyperspectral image super-resolution by reducing artifacts and modal conflicts, outperforming existing methods with computational efficiency.


<details>
  <summary>Details</summary>
Motivation: Address potential artifacts in Visual Mamba's 1D scanning and modal conflicts between spatial and spectral features.

Method: Introduces strip-based scanning and wavelet decomposition to enhance performance.
...
### [249] [Towards Self-Improvement of Diffusion Models via Group Preference Optimization](https://arxiv.org/abs/2505.11070)
*Renjie Chen,Wenfeng Lin,Yichen Zhang,Jiangchuan Wei,Boyuan Liu,Chao Feng,Jiao Ran,Mingyu Guo*

Main category: cs.CV

TL;DR: The paper introduces Group Preference Optimization (GPO), an improved method for aligning text-to-image diffusion models by addressing challenges in Direct Preference Optimization (DPO). GPO enhances performance without extra data or inference overhead.


<details>
  <summary>Details</summary>
Motivation: DPO's sensitivity to preference pairs and the labor-intensive data collection process limit its effectiveness in text-to-image alignment.

Method: Extends DPO to groupwise comparisons and incorporates reward standardization for reweighting, proposing GPO as a self-improvement method.

Result: GPO improves Stable Diffusion 3.5 Medium's counting and text rendering by 20 percentage points, with no added inference overhead.

Conclusion: GPO is a plug-and-play solution that enhances diffusion models effectively across tasks and models.
...
### [250] [Pseudo-Label Quality Decoupling and Correction for Semi-Supervised Instance Segmentation](https://arxiv.org/abs/2505.11075)
*Jianghang Lin,Yilin Lu,Yunhang Shen,Chaoyang Zhu,Shengchuan Zhang,Liujuan Cao,Rongrong Ji*

Main category: cs.CV

TL;DR: The paper introduces PL-DC, a framework for Semi-Supervised Instance Segmentation (SSIS) that decouples and corrects pseudo-label quality to improve performance with limited labeled data.


<details>
  <summary>Details</summary>
Motivation: The challenge of unstable performance in SSIS due to noisy pseudo-labels for instance categories and pixel masks motivates the need for a better filtering and correction mechanism.

Method: PL-DC uses a dual-threshold filtering mechanism for instance-level pseudo-labels, a dynamic category correction module, and a pixel-level mask uncertainty-aware mechanism.

Result: PL-DC achieves significant improvements, e.g., +11.6 mAP with 1% COCO labeled data and +15.5 mAP with 5% Cityscapes labeled data, setting new state-of-the-art results.

Conclusion: The proposed PL-DC framework effectively addresses pseudo-label noise in SSIS, demonstrating superior performance with minimal labeled data.
...
### [251] [Hybrid-Emba3D: Geometry-Aware and Cross-Path Feature Hybrid Enhanced State Space Model for Point Cloud Classification](https://arxiv.org/abs/2505.11099)
*Bin Liu,Chunyang Wang,Xuelian Liu,Guan Xi,Ge Zhang,Ziteng Yao,Mengxue Dong*

Main category: cs.CV

TL;DR: Hybrid-Emba3D, a bidirectional Mamba model with geometry-feature coupling and cross-path hybridization, achieves 95.99% accuracy on ModelNet40 by enhancing local geometric feature extraction without added complexity.


<details>
  <summary>Details</summary>
Motivation: Address the challenge of extracting local geometric features in point cloud classification while maintaining model efficiency, overcoming the limitations of unidirectional Mamba architectures.

Method: Proposes Hybrid-Emba3D with geometry-feature coupling for local feature enhancement and cross-path hybridization to handle local mutations and sparse signals.

Result: Achieves state-of-the-art 95.99% classification accuracy on ModelNet40 with minimal additional parameters (0.03M).

Conclusion: Hybrid-Emba3D effectively balances local geometric feature extraction and global modeling, outperforming existing methods with minimal computational overhead.
...
### [252] [MAVOS-DD: Multilingual Audio-Video Open-Set Deepfake Detection Benchmark](https://arxiv.org/abs/2505.11109)
*Florinel-Alin Croitoru,Vlad Hondru,Marius Popescu,Radu Tudor Ionescu,Fahad Shahbaz Khan,Mubarak Shah*

Main category: cs.CV

TL;DR: A large-scale multilingual audio-video deepfake detection benchmark is introduced, featuring 250+ hours of real and fake videos across eight languages, with 60% fake data. Open-set evaluation shows current detectors struggle with unseen generative models and languages.


<details>
  <summary>Details</summary>
Motivation: To address the lack of large-scale, multilingual open-set benchmarks for audio-video deepfake detection, enabling robust evaluation of detectors.

Method: The dataset includes real and fake videos from eight languages, generated by seven distinct models. Training, validation, and test splits are designed to challenge detectors with unseen models and languages.

Result: State-of-the-art detectors fail to maintain performance in open-set scenarios, highlighting the challenge of generalization.

Conclusion: The benchmark exposes limitations of current deepfake detectors in open-set settings, encouraging further research. Data and code are publicly released.
...
### [253] [Deepfake Forensic Analysis: Source Dataset Attribution and Legal Implications of Synthetic Media Manipulation](https://arxiv.org/abs/2505.11110)
*Massimiliano Cassia,Luca Guarnera,Mirko Casu,Ignazio Zangara,Sebastiano Battiato*
...
Method: Integrates spectral transforms (Fourier/DCT), color distribution metrics, and local feature descriptors (SIFT) with supervised classifiers (Random Forest, SVM, XGBoost).

Result: 98-99% accuracy in binary and multi-class classification, highlighting frequency-domain features and color histograms as key discriminators.

Conclusion: The framework enhances accountability in generative modeling, with applications in forensics, moderation, and legal compliance.
...
### [254] [Redundancy-Aware Pretraining of Vision-Language Foundation Models in Remote Sensing](https://arxiv.org/abs/2505.11121)
*Mathis Jürgen Adler,Leonard Hackel,Gencer Sumbul,Begüm Demir*

Main category: cs.CV

TL;DR: The paper introduces a weighted feature aggregation (WFA) strategy for vision-language model (VLM) pretraining in remote sensing (RS) to handle redundant captions and improve efficiency.


<details>
  <summary>Details</summary>
Motivation: Redundant captions in RS image-text pairs increase pretraining and inference time, necessitating a method to reduce redundancies while retaining complementary information.

Method: Proposes WFA with two techniques: (i) non-parametric uniqueness (BLEU-based weights) and (ii) learning-based attention (adaptive weights).

Result: WFA improves VLM pretraining efficiency and downstream text-to-image retrieval performance in RS.

Conclusion: The strategy is effective, and guidelines are provided for technique selection based on task requirements and resources.
...
### [255] [PhiNet v2: A Mask-Free Brain-Inspired Vision Foundation Model from Video](https://arxiv.org/abs/2505.11129)
*Makoto Yamada,Kian Ming A. Chai,Ayoub Rhim,Satoki Ishikawa,Mohammad Sabokrou,Yao-Hung Hubert Tsai*

Main category: cs.CV

TL;DR: PhiNet v2 is a Transformer-based SSL model for temporal visual input, achieving competitive performance without strong augmentation, aligning with human visual processing.


<details>
  <summary>Details</summary>
Motivation: To bridge the gap between SSL in computer vision and biological visual processing by introducing a more biologically plausible model.

Method: Uses a Transformer-based architecture with variational inference to process sequences of images (temporal input) without strong augmentation.

Result: Competes with state-of-the-art vision models while learning from sequential input naturally.

Conclusion: PhiNet v2 advances biologically plausible computer vision, aligning closer with human cognitive processes.
...
### [256] [One Image is Worth a Thousand Words: A Usability Preservable Text-Image Collaborative Erasing Framework](https://arxiv.org/abs/2505.11131)
*Feiran Li,Qianqian Xu,Shilong Bao,Zhiyong Yang,Xiaochun Cao,Qingming Huang*

Main category: cs.CV

TL;DR: The paper introduces Co-Erasing, a text-image collaborative framework for concept erasure in diffusion models, improving efficacy and usability by integrating visual supervision and negative guidance.


<details>
  <summary>Details</summary>
Motivation: Current concept erasure methods rely on manual text prompts, leading to inefficacy and usability issues due to the text-image modality gap.

Method: Proposes Co-Erasing, which uses text prompts and undesirable images for joint concept description, employs negative guidance for erasure, and refines concepts via text-guided image refinement.

Result: Co-Erasing outperforms state-of-the-art methods, achieving better efficacy-usability trade-off.

Conclusion: The framework effectively bridges the text-image gap, enhancing concept erasure while preserving benign concepts.
...
### [257] [Human-Aligned Bench: Fine-Grained Assessment of Reasoning Ability in MLLMs vs. Humans](https://arxiv.org/abs/2505.11141)
*Yansheng Qiu,Li Xiao,Zhaopan Xu,Pengfei Zhou,Zheng Wang,Kaipeng Zhang*
...
<details>
  <summary>Details</summary>
Motivation: To assess whether AI models like MLLMs can match human reasoning capabilities in multimodal tasks.

Method: Developed a benchmark with 9,794 multimodal questions across four reasoning types, incorporating human success rates and error-prone options.

Result: Experiments show significant performance gaps between current MLLMs and humans in multimodal reasoning.

Conclusion: The benchmark highlights areas for improvement in AI models, guiding future development toward human-like reasoning.
...
### [258] [Learning Dense Hand Contact Estimation from Imbalanced Data](https://arxiv.org/abs/2505.11152)
*Daniel Sungho Jung,Kyoung Mu Lee*
...
<details>
  <summary>Details</summary>
Motivation: Understanding hand interactions is crucial, but existing datasets suffer from class and spatial imbalances, hindering effective learning of dense hand contact estimation.

Method: Proposes balanced contact sampling for class imbalance and a vertex-level class-balanced (VCB) loss for spatial imbalance.

Result: The framework effectively learns dense hand contact estimation without suffering from imbalance issues.

Conclusion: The proposed HACO framework successfully addresses dataset imbalances, improving hand contact estimation.
...
### [259] [CheX-DS: Improving Chest X-ray Image Classification with Ensemble Learning Based on DenseNet and Swin Transformer](https://arxiv.org/abs/2505.11168)
*Xinran Li,Yu Liu,Xiujuan Xu,Xiaowei Zhao*

Main category: cs.CV

TL;DR: The paper proposes CheX-DS, a model combining CNN (DenseNet) and Swin Transformer for classifying chest X-rays, addressing data imbalance with a novel loss function. It achieves an AUC of 83.76%.


<details>
  <summary>Details</summary>
Motivation: Current CNN-based methods for chest disease diagnosis neglect global features. Self-attention mechanisms (Transformers) show promise, motivating the hybrid approach.

Method: CheX-DS combines DenseNet (CNN) and Swin Transformer via ensemble learning, using weighted binary cross-entropy and asymmetric loss to handle data imbalance.

Result: Evaluated on NIH ChestX-ray14, CheX-DS achieves an average AUC of 83.76%, outperforming prior methods.

Conclusion: The hybrid model effectively leverages CNNs and Transformers, demonstrating superior performance in chest X-ray classification.
...
### [260] [CompAlign: Improving Compositional Text-to-Image Generation with a Complex Benchmark and Fine-Grained Feedback](https://arxiv.org/abs/2505.11178)
*Yixin Wan,Kai-Wei Chang*

Main category: cs.CV

TL;DR: CompAlign is a benchmark for evaluating T2I models on compositional image generation, focusing on 3D-spatial relationships. CompQuest provides fine-grained feedback for alignment, improving model performance.
...
Method: Introduces CompAlign (900 complex prompts) and CompQuest (decomposes prompts for fine-grained evaluation). Proposes an alignment framework using CompQuest's feedback to improve models.

Result: Models struggle more with complex 3D-spatial tasks, and a performance gap exists between open-source and commercial models. Post-alignment models show significant improvements.

Conclusion: CompAlign and CompQuest effectively address compositional challenges, enabling better alignment and performance in T2I models.
...
### [261] [Imputation-free and Alignment-free: Incomplete Multi-view Clustering Driven by Consensus Semantic Learning](https://arxiv.org/abs/2505.11182)
*Yuzhuo Dai,Jiaqi Jin,Zhibin Dong,Siwei Wang,Xinwang Liu,En Zhu,Xihong Yang,Xinbiao Gan,Yu Feng*
...
Conclusion: The proposed framework effectively bridges semantic gaps and enhances clustering performance in incomplete multi-view data.
...
### [262] [FALCON: False-Negative Aware Learning of Contrastive Negatives in Vision-Language Pretraining](https://arxiv.org/abs/2505.11192)
*Myunsoo Kim,Seong-Woong Shim,Byung-Jun Lee*
...
<details>
  <summary>Details</summary>
Motivation: False negatives in VLP degrade embedding quality and hard negative sampling effectiveness.

Method: FALCON uses a negative mining scheduler to adaptively select negatives during mini-batch construction, guided by cross-modal alignment.

Result: FALCON enhances performance in ALBEF and BLIP-2 frameworks and various downstream tasks.

Conclusion: FALCON effectively mitigates false negatives' impact, proving robust and adaptable in VLP.
...
### [263] [DiCo: Revitalizing ConvNets for Scalable and Efficient Diffusion Modeling](https://arxiv.org/abs/2505.11196)
*Yuang Ai,Qihang Fan,Xuefeng Hu,Zhenheng Yang,Ran He,Huaibo Huang*
...
<details>
  <summary>Details</summary>
Motivation: The computational overhead of DiT and the redundancy in its global self-attention highlight the need for more efficient diffusion models.

Method: Replace self-attention with convolution and introduce a compact channel attention mechanism to enhance feature diversity.

Result: DiCo outperforms DiT in image quality and speed, achieving FID scores of 2.05 (256x256) and 2.53 (512x512) with significant speedups.

Conclusion: DiCo demonstrates that ConvNets can be a powerful and efficient alternative to Transformers in diffusion models, achieving state-of-the-art performance.
...
### [264] [GeoMM: On Geodesic Perspective for Multi-modal Learning](https://arxiv.org/abs/2505.11216)
*Shibin Mei,Hang Wang,Bingbing Ni*

Main category: cs.CV

TL;DR: The paper introduces geodesic distance as a novel metric in multimodal learning to address the limitations of traditional distance metrics in distinguishing semantically different but similar samples.


<details>
  <summary>Details</summary>
Motivation: Traditional distance metrics fail to distinguish samples with high similarity but different semantics in nonlinear manifolds common in multimodal learning.

Method: The method constructs a graph structure for adjacency relationships, applies the shortest-path algorithm for geodesic distance, and uses hierarchical clustering and incremental updates for efficiency.

Result: Experiments show the method effectively captures complex sample relationships and improves multimodal learning performance.

Conclusion: Geodesic distance is a viable and effective metric for enhancing multimodal learning by addressing traditional metric limitations.
...
### [265] [AW-GATCN: Adaptive Weighted Graph Attention Convolutional Network for Event Camera Data Joint Denoising and Object Recognition](https://arxiv.org/abs/2505.11232)
*Haiyu Li,Charith Abhayaratne*

Main category: cs.CV

TL;DR: Proposes an adaptive graph-based framework for noisy data removal in event-based object recognition, achieving superior accuracy and noise reduction.


<details>
  <summary>Details</summary>
Motivation: Event cameras produce redundant and noisy data, challenging effective object recognition without losing critical spatiotemporal information.

Method: Integrates adaptive event segmentation, multifactorial edge-weighting, and adaptive graph-based denoising to filter noise while preserving structural features.

Result: Achieves recognition accuracies of 83.77%, 76.79%, 99.30%, and 96.89% on four datasets, outperforming existing methods by up to 8.79%.

Conclusion: The framework effectively enhances spatiotemporal information integration, improving recognition accuracy and noise reduction performance.
...
### [266] [Diffusion-NPO: Negative Preference Optimization for Better Preference Aligned Generation of Diffusion Models](https://arxiv.org/abs/2505.11245)
*Fu-Yun Wang,Yunhao Shui,Jingtan Piao,Keqiang Sun,Hongsheng Li*

Main category: cs.CV

TL;DR: The paper addresses the issue of diffusion models generating outputs misaligned with human preferences and proposes a method to improve alignment by training a model attuned to negative preferences, enhancing existing techniques without new training strategies.


<details>
  <summary>Details</summary>
Motivation: Existing preference alignment methods for diffusion models overlook the importance of handling unconditional/negative-conditional outputs, limiting the effectiveness of classifier-free guidance (CFG) in optimizing output quality.

Method: The authors propose training a model specifically attuned to negative preferences, requiring minor modifications to existing techniques and no new training strategies or datasets.

Result: The method integrates seamlessly with models like SD1.5, SDXL, and video diffusion models, consistently improving alignment with human preferences.

Conclusion: The proposed approach effectively enhances the alignment of diffusion model outputs with human preferences by addressing the oversight of negative-conditional outputs in existing methods.
...
### [267] [Entropy-Driven Genetic Optimization for Deep-Feature-Guided Low-Light Image Enhancement](https://arxiv.org/abs/2505.11246)
*Nirjhor Datta,Afroza Akther,M. Sohel Rahman*

Main category: cs.CV

TL;DR: An unsupervised, fuzzy-inspired image enhancement framework using NSGA-II optimizes brightness, contrast, and gamma for visual and semantic balance, achieving strong quantitative and qualitative results.


<details>
  <summary>Details</summary>
Motivation: Existing methods focus on pixel-level details, neglecting semantic features, which this work addresses by balancing visual quality and semantic fidelity.

Method: Uses a pre-trained deep neural network for feature extraction and a GPU-accelerated NSGA-II algorithm to optimize multiple objectives (entropy, perceptual similarity, brightness), followed by local search for fine-tuning.

Result: Achieves average BRISQUE (19.82) and NIQE (3.652) scores, with improved visibility in shadows, natural contrast, and preserved fine details.

Conclusion: The framework advances unsupervised image enhancement, emphasizing semantic consistency and broad applicability without paired training data.
...
### [268] [DRAGON: A Large-Scale Dataset of Realistic Images Generated by Diffusion Models](https://arxiv.org/abs/2505.11257)
*Giulia Bertazzini,Daniele Baracchi,Dasara Shullani,Isao Echizen,Alessandro Piva*

Main category: cs.CV

TL;DR: DRAGON is a comprehensive dataset of images from 25 diffusion models, designed to aid in detecting synthetic content. It includes diverse images and a test set for benchmarking.


<details>
  <summary>Details</summary>
Motivation: The rise of synthetic content from diffusion models necessitates robust detection tools, but current datasets are limited and outdated.

Method: DRAGON combines images from various diffusion models and uses a pipeline with a large language model to enhance realism and diversity.

Result: The dataset improves quality metrics and supports forensic research in synthetic content detection.

Conclusion: DRAGON addresses dataset limitations and provides a benchmark for evaluating detection methods.
...
### [269] [Multi-view dense image matching with similarity learning and geometry priors](https://arxiv.org/abs/2505.11264)
*Mohamed Ali Chebbi,Ewelina Rupnik,Paul Lopes,Marc Pierrot-Deseilligny*

Main category: cs.CV

TL;DR: MV-DeepSimNets is a deep neural network suite for multi-view similarity learning, using epipolar geometry to improve multi-view reconstruction without extensive training data.
...
Method: Incorporates online geometry priors for pixel relationships, projects features across depth hypotheses, and aggregates similarities to regularize cost volumes.

Result: Outperforms leading similarity learning and regression models, especially in generalization across aerial and satellite imagery.

Conclusion: MV-DeepSimNets offers a practical, high-performance solution for multi-view reconstruction, integrated into MicMac software.
...
### [270] [Equal is Not Always Fair: A New Perspective on Hyperspectral Representation Non-Uniformity](https://arxiv.org/abs/2505.11267)
*Wuzhou Quan,Mingqiang Wei,Jinhui Tang*

Main category: cs.CV

TL;DR: FairHyp is a fairness-directed framework for hyperspectral image representation, addressing non-uniformity via specialized modules, outperforming state-of-the-art methods in tasks like classification and denoising.


<details>
  <summary>Details</summary>
Motivation: Existing HSI models assume homogeneity, leading to suboptimal performance. FairHyp tackles non-uniformity by disentangling spectral, spatial, and feature dependencies.

Method: FairHyp uses a Runge-Kutta-inspired spatial adapter, multi-receptive field convolution, and a spectral-context state space model for dimension-specific adaptation.
...
### [271] [MTevent: A Multi-Task Event Camera Dataset for 6D Pose Estimation and Moving Object Detection](https://arxiv.org/abs/2505.11282)
*Shrutarv Awasthi,Anas Gouda,Sven Franke,Jérôme Rutinowski,Frank Hoffmann,Moritz Roidl*

Main category: cs.CV

TL;DR: MTevent is a new dataset for 6D pose estimation and moving object detection in high-speed, dynamic environments using event cameras, addressing RGB camera limitations.


<details>
  <summary>Details</summary>
Motivation: RGB cameras struggle with motion blur and latency in high-speed robotics, while event cameras offer low-latency sensing.

Method: The dataset includes stereo-event and RGB camera captures of 75 scenes with 16 unique objects under challenging conditions.

Result: Baseline evaluation of RGB-based 6D pose estimation shows low performance (Average Recall 0.22), highlighting the need for event-based solutions.

Conclusion: MTevent provides a valuable resource for advancing event-based vision in robotics, addressing high-speed and long-range perception challenges.
...
### [272] [Breaking the Batch Barrier (B3) of Contrastive Learning via Smart Batch Mining](https://arxiv.org/abs/2505.11293)
*Raghuveer Thirukovalluru,Rui Meng,Ye Liu,Karthikeyan K,Mingyi Su,Ping Nie,Semih Yavuz,Yingbo Zhou,Wenhu Chen,Bhuwan Dhingra*
...
<details>
  <summary>Details</summary>
Motivation: Contrastive learning's effectiveness depends on batch quality and size. Current methods require large batches, which B3 aims to overcome.

Method: B3 uses a pretrained teacher model to rank examples, constructs a similarity graph, applies community detection for clusters, and forms batches rich in negatives.

Result: B3 outperforms prior methods by +1.3 and +2.9 points on MMEB, achieving state-of-the-art results with batch sizes 4-16x smaller.

Conclusion: B3 is a scalable, efficient method for contrastive learning, enabling high performance with significantly reduced batch sizes.
...
### [273] [CROC: Evaluating and Training T2I Metrics with Pseudo- and Human-Labeled Contrastive Robustness Checks](https://arxiv.org/abs/2505.11314)
*Christoph Leiter,Yuki M. Asano,Margret Keuper,Steffen Eger*

Main category: cs.CV

TL;DR: The paper introduces CROC, a scalable framework for automated meta-evaluation of text-to-image generation metrics, addressing the limitations of human-based methods. It includes a synthetic dataset (CROC$^{syn}$) and a human-supervised benchmark (CROC$^{hum}$), revealing robustness issues in existing metrics.
...
Method: Proposes CROC, a framework for automated contrastive robustness checks, synthesizing contrastive test cases and generating a pseudo-labeled dataset (CROC$^{syn}$). Also introduces CROCScore, a new metric trained on this dataset.

Result: CROCScore achieves state-of-the-art performance, and the framework exposes robustness issues in existing metrics (e.g., failure on prompts with negation or body parts).

Conclusion: CROC provides a scalable, automated solution for meta-evaluation, with applications in improving evaluation metrics for text-to-image generation.
...
### [274] [Temporally-Grounded Language Generation: A Benchmark for Real-Time Vision-Language Models](https://arxiv.org/abs/2505.11326)
*Keunwoo Peter Yu,Joyce Chai*

Main category: cs.CV

TL;DR: The paper introduces a benchmark task (TGLG) for real-time vision-language models, requiring precise timing and semantic accuracy. It proposes VLM-TSI, a model for time-synchronized language generation, and a new metric (TRACE) for evaluation. Results show promise but highlight challenges.


<details>
  <summary>Details</summary>
Motivation: Real-time interactive environments demand VLMs to generate timely and accurate utterances, which existing models lack. The paper addresses this gap by focusing on perceptual updating and contingency awareness.

Method: The authors propose TGLG as a benchmark task, curate datasets from sports and egocentric interactions, and introduce TRACE for evaluation. They also develop VLM-TSI, a model that interleaves visual and linguistic tokens in real-time.
...
### [275] [MARRS: Masked Autoregressive Unit-based Reaction Synthesis](https://arxiv.org/abs/2505.11334)
*Y. B. Wang,S Wang,J. N. Zhang,J. F. Wu,Q. D. He,C. C. Fu,C. J. Wang,Y. Liu*

Main category: cs.CV

TL;DR: The paper introduces MARRS, a framework for human action-reaction synthesis, addressing challenges like fine-grained hand movements and autoregressive modeling limitations.


<details>
  <summary>Details</summary>
Motivation: To overcome the shortcomings of autoregressive modeling and vector quantization in generating human reactions, especially for fine-grained hand movements.
...
Result: The method achieves superior performance in generating coordinated and fine-grained reaction motions.

Conclusion: MARRS effectively addresses the challenges of human action-reaction synthesis, demonstrating significant improvements over existing approaches.
...
### [276] [Dynamic Base model Shift for Delta Compression](https://arxiv.org/abs/2505.11344)
*Chenyu Huang,Peng Ye,Shenghe Zheng,Xiaohui Wang,Lei Bai,Tao Chen,Wanli Ouyang*

Main category: cs.CV

TL;DR: The paper proposes Dynamic Base Model Shift (DBMS) to improve delta compression by dynamically adapting the base model for each task, enhancing performance under high compression rates.
...
Method: DBMS dynamically adjusts the base model and delta compression scale for each task through low-cost parameter learning.

Result: DBMS maintains performance under extreme compression, outperforming existing methods, and works across various model types.

Conclusion: DBMS is a versatile and effective solution for delta compression, compatible with other methods and models.
...
### [277] [EmotionHallucer: Evaluating Emotion Hallucinations in Multimodal Large Language Models](https://arxiv.org/abs/2505.11405)
*Bohao Xing,Xin Liu,Guoying Zhao,Chengyu Liu,Xiaolan Fu,Heikki Kälviäinen*
...
<details>
  <summary>Details</summary>
Motivation: Address the lack of dedicated evaluation for emotion-related hallucinations in MLLMs, despite their critical role in emotion understanding.

Method: Developed EmotionHallucer benchmark using an adversarial binary QA framework to assess hallucinations based on emotion psychology knowledge and multimodal perception. Evaluated 38 models.

Result: Most models struggle with emotion hallucinations; closed-source models outperform open-source ones; models perform better in emotion psychology than multimodal perception.

Conclusion: Proposes PEP-MEK framework, improving detection by 9.90%, and highlights the need for better emotion understanding in MLLMs.
...
### [278] [Dynam3D: Dynamic Layered 3D Tokens Empower VLM for Vision-and-Language Navigation](https://arxiv.org/abs/2505.11383)
*Zihan Wang,Seungjun Lee,Gim Hee Lee*

Main category: cs.CV

TL;DR: Dynam3D is a dynamic layered 3D representation model addressing VLN challenges like 3D understanding, large-scale exploration, and adaptability, achieving state-of-the-art results on benchmarks.


<details>
  <summary>Details</summary>
Motivation: Current Video-VLMs struggle with 3D geometry understanding, large-scale exploration, and dynamic environments in VLN tasks.

Method: Dynam3D projects 2D CLIP features into 3D space, creating multi-level representations with dynamic updates for geometric and semantic understanding.

Result: Dynam3D achieves top performance on VLN benchmarks (R2R-CE, REVERIE-CE, NavRAG-CE) and validates practical deployment in real-world scenarios.

Conclusion: Dynam3D effectively addresses VLN challenges, offering scalable and adaptable solutions for real-world navigation.
...
### [279] [MutualNeRF: Improve the Performance of NeRF under Limited Samples with Mutual Information Theory](https://arxiv.org/abs/2505.11386)
*Zifan Wang,Jingwei Li,Yitang Li,Yunze Liu*
...
<details>
  <summary>Details</summary>
Motivation: NeRF struggles with limited data, and existing methods lack theoretical support. Mutual Information Theory provides a unified framework to measure image correlations.

Method: Uses Mutual Information to select viewpoints (minimizing MI) and improve synthesis (maximizing MI), with a greedy algorithm and plug-and-play regularization.

Result: Consistent improvements over state-of-the-art baselines in limited-sample settings.

Conclusion: MutualNeRF effectively addresses NeRF's limitations with limited data, offering a robust and efficient solution.
...
### [280] [Patho-R1: A Multimodal Reinforcement Learning-Based Pathology Expert Reasoner](https://arxiv.org/abs/2505.11404)
*Wenchuan Zhang,Penghao Zhang,Jingru Guo,Tao Cheng,Jie Chen,Shuwan Zhang,Zhang Zhang,Yuhao Yi,Hong Bu*

Main category: cs.CV

TL;DR: The paper introduces Patho-R1, a multimodal RL-based pathology Reasoner, and PathoCLIP, both trained on high-quality, reasoning-oriented datasets to improve diagnostic accuracy and reasoning plausibility in pathology.


<details>
  <summary>Details</summary>
Motivation: Current pathology-specific VLMs lack depth and structured diagnostic paradigms, limiting their accuracy and plausibility. The study aims to address this by leveraging expert knowledge and textbooks to create better datasets.

Method: A three-stage pipeline: (1) pretraining on image-text pairs, (2) supervised fine-tuning on Chain-of-Thought samples, (3) reinforcement learning for reasoning refinement. PathoCLIP is also introduced for alignment assessment.

Result: Both Patho-R1 and PathoCLIP achieve robust performance in tasks like zero-shot classification, cross-modal retrieval, VQA, and MCQs.

Conclusion: The study successfully improves pathology VLMs by integrating high-quality datasets and advanced training methods, demonstrating strong performance across multiple tasks.
...
### [281] [Improving Object Detection Performance through YOLOv8: A Comprehensive Training and Evaluation Study](https://arxiv.org/abs/2505.11424)
*Rana Poureskandar,Shiva Razzagzadeh*
...
Result: Performance of the model in detecting and segmenting wrinkles was evaluated.
...
### [282] [Face Consistency Benchmark for GenAI Video](https://arxiv.org/abs/2505.11425)
*Michal Podstawski,Malgorzata Kudelska,Haohong Wang*
...
Method: The paper proposes the FCB, a framework with standardized metrics to assess and compare character consistency in videos.

Result: The benchmark identifies gaps in existing solutions and encourages the development of more reliable methods.

Conclusion: The FCB is a significant advancement toward improving character consistency in AI-generated videos.
...
### [283] [SurgPose: Generalisable Surgical Instrument Pose Estimation using Zero-Shot Learning and Stereo Vision](https://arxiv.org/abs/2505.11439)
*Utsav Rai,Haozheng Xu,Stamatia Giannarou*
...
Method: The pipeline leverages zero-shot RGB-D models (FoundationPose, SAM-6D) with vision-based depth estimation (RAFT-Stereo) and replaces SAM with fine-tuned Mask R-CNN for better segmentation.

Result: The enhanced SAM-6D outperforms FoundationPose in zero-shot pose estimation of unseen surgical tools, setting a new benchmark for RMIS.

Conclusion: This work advances zero-shot pose estimation in RMIS, improving generalizability for unseen tools and pioneering RGB-D zero-shot methods in the field.
...
### [284] [HumaniBench: A Human-Centric Framework for Large Multimodal Models Evaluation](https://arxiv.org/abs/2505.11454)
*Shaina Raza,Aravind Narayanan,Vahid Reza Khazaie,Ashmal Vayani,Mukund S. Chettiar,Amandeep Singh,Mubarak Shah,Deval Pandya*

Main category: cs.CV

TL;DR: HumaniBench is a new benchmark evaluating Large Multimodal Models (LMMs) on human-centered AI principles like fairness, ethics, and empathy. It includes 32K image-question pairs and tests 15 LMMs, revealing gaps in robustness and alignment with human values.


<details>
  <summary>Details</summary>
Motivation: Current LMMs excel in vision-language tasks but lack alignment with human-centered criteria such as fairness, ethics, and inclusivity. HumaniBench aims to address this gap.

Method: HumaniBench uses a GPT4-assisted annotation pipeline to create 32K image-question pairs, evaluated by domain experts. It assesses seven HCAI principles across seven diverse tasks.
...
Conclusion: HumaniBench is the first benchmark focused on HCAI principles, providing a testbed to improve LMM alignment with human values. The dataset and tools are publicly available.
...
### [285] [PSDiffusion: Harmonized Multi-Layer Image Generation via Layout and Appearance Alignment](https://arxiv.org/abs/2505.11468)
*Dingbang Huang,Wenbo Li,Yifei Zhao,Xinyu Pan,Yanhong Zeng,Bo Dai*

Main category: cs.CV

TL;DR: PSDiffusion is a unified diffusion framework for simultaneous multi-layer text-to-image generation, addressing interactions among layers while maintaining high quality.


<details>
  <summary>Details</summary>
Motivation: Existing multi-layer generation methods fail to handle interactions among layers (e.g., layout, contacts, shadows) and maintain alpha quality.
...
Result: The model generates multi-layer images (RGB background + RGBA foregrounds) with high quality, completeness, and global coherence.

Conclusion: PSDiffusion outperforms existing methods by ensuring spatial and visual interactions among layers for coherent multi-layer image generation.
...
### [286] [Unsupervised Detection of Distribution Shift in Inverse Problems using Diffusion Models](https://arxiv.org/abs/2505.11482)
*Shirin Shoushtari,Edward P. Chandler,Yuanhao Wang,M. Salman Asif,Ulugbek S. Kamilov*

Main category: cs.CV

TL;DR: The paper proposes an unsupervised metric for estimating distribution shifts in imaging inverse problems using corrupted measurements and diffusion model scores, showing it approximates KL divergence and improves reconstruction.


<details>
  <summary>Details</summary>
Motivation: Diffusion models degrade under distribution shifts, and existing methods require clean test images, which are unavailable in inverse problems.

Method: A score-based metric using corrupted measurements and diffusion model scores to estimate KL divergence between training and test distributions.

Result: The metric approximates KL divergence from clean images, and aligning scores improves reconstruction quality.

Conclusion: The proposed unsupervised metric effectively estimates distribution shifts and enhances reconstruction without needing clean images.
...
### [287] [GIE-Bench: Towards Grounded Evaluation for Text-Guided Image Editing](https://arxiv.org/abs/2505.11493)
*Yusu Qian,Jiasen Lu,Tsu-Jui Fu,Xinze Wang,Chen Chen,Yinfei Yang,Wenze Hu,Zhe Gan*

Main category: cs.CV

TL;DR: A new benchmark, GIE-Bench, is introduced to evaluate text-guided image editing models more precisely, focusing on functional correctness and content preservation. It includes 1000+ examples and compares models like GPT-Image-1, revealing trade-offs in performance.


<details>
  <summary>Details</summary>
Motivation: Existing evaluation methods for text-guided image editing lack precision, relying on metrics like CLIP. A more grounded benchmark is needed to assess functional correctness and content preservation.

Method: The benchmark uses automatically generated multiple-choice questions for functional correctness and object-aware masking for content preservation. It includes 1000+ examples across 20 categories.

Result: GPT-Image-1 leads in instruction-following accuracy but over-modifies irrelevant regions. The benchmark validates automatic metrics against human ratings.

Conclusion: GIE-Bench offers a scalable, reproducible framework for improving evaluation in text-guided image editing, highlighting current model trade-offs.
...
### [288] [QVGen: Pushing the Limit of Quantized Video Generative Models](https://arxiv.org/abs/2505.11497)
*Yushi Huang,Ruihao Gong,Jing Liu,Yifu Ding,Chengtao Lv,Haotong Qin,Jun Zhang*
...
<details>
  <summary>Details</summary>
Motivation: Video diffusion models face high computational and memory demands, and existing quantization methods are ineffective for them. QVGen aims to address this gap.
...
Result: QVGen achieves full-precision comparable quality under 4-bit settings and outperforms existing methods, e.g., improving Dynamic Degree by +25.28 and Scene Consistency by +8.43 on VBench.

Conclusion: QVGen successfully enables efficient and high-quality video synthesis under extreme low-bit quantization, setting a new benchmark for video diffusion models.
...
### [289] [Two Minds Better Than One: Collaborative Reward Modeling for LLM Alignment](https://arxiv.org/abs/2505.10597)
...
### [290] [UDDETTS: Unifying Discrete and Dimensional Emotions for Controllable Emotional Text-to-Speech](https://arxiv.org/abs/2505.10599)
...
### [291] [LARGO: Latent Adversarial Reflection through Gradient Optimization for Jailbreaking LLMs](https://arxiv.org/abs/2505.10838)
...
### [292] [Maximizing Asynchronicity in Event-based Neural Networks](https://arxiv.org/abs/2505.11165)
...
### [293] [Visual Planning: Let's Think Only with Images](https://arxiv.org/abs/2505.11409)
...
### [294] [A probabilistic framework for dynamic quantization](https://arxiv.org/abs/2505.10689)
...
### [295] [Hashing for Structure-based Anomaly Detection](https://arxiv.org/abs/2505.10873)
...
### [296] [MultiLink: Multi-class Structure Recovery via Agglomerative Clustering and Model Selection](https://arxiv.org/abs/2505.10874)
...
### [297] [Preference Isolation Forest for Structure-based Anomaly Detection](https://arxiv.org/abs/2505.10876)
*Filippo Leveni,Luca Magri,Cesare Alippi,Giacomo Boracchi*
...
### [298] [CTP: A hybrid CNN-Transformer-PINN model for ocean front forecasting](https://arxiv.org/abs/2505.10894)
...
### [299] [Assessing the Performance of Analog Training for Transfer Learning](https://arxiv.org/abs/2505.11067)
...
### [300] [What's Inside Your Diffusion Model? A Score-Based Riemannian Metric to Explore the Data Manifold](https://arxiv.org/abs/2505.11128)
...
### [301] [Towards Robust Spiking Neural Networks:Mitigating Heterogeneous Training Vulnerability via Dominant Eigencomponent Projection](https://arxiv.org/abs/2505.11134)
...
### [302] [Two Minds Better Than One: Collaborative Reward Modeling for LLM Alignment](https://arxiv.org/abs/2505.10597)
*Jiazheng Zhang,Wenqing Jing,Zizhuo Zhang,Zhiheng Xi,Shihan Dou,Rongxiang Weng,Jiahuan Li,Jingang Wang,MingXu Cai,Shibo Hong,Tao Gui,Qi Zhang*

Main category: cs.LG

TL;DR: CRM improves reward model robustness by combining peer review and curriculum learning to filter noisy preferences, achieving better alignment of LLMs with human values.
...
Method: Proposes Collaborative Reward Modeling (CRM), an online framework using peer review and curriculum learning to filter noise and structure training from easy to hard.

Result: CRM improves generalization, with up to 9.94 points accuracy gain on RewardBench under 40% label noise.

Conclusion: CRM offers a practical and versatile strategy for robust alignment, compatible with implicit-reward methods.
...
TL;DR: UDDETTS is a neural codec language model for controllable emotional TTS, combining discrete and dimensional emotions using the ADV space, and employs a semi-supervised training strategy for improved performance.


<details>
  <summary>Details</summary>
Motivation: Traditional TTS methods struggle with capturing the complexity of human emotions due to reliance on discrete labels and lack of balanced datasets.

Method: Proposes UDDETTS, integrating discrete and dimensional emotions via the ADV space, and uses semi-supervised training with diverse datasets.

Result: UDDETTS achieves linear emotion control in ADV space and superior emotional speech synthesis.

Conclusion: UDDETTS addresses limitations of traditional methods, enabling more nuanced and controllable emotional TTS.
...
### [304] [LARGO: Latent Adversarial Reflection through Gradient Optimization for Jailbreaking LLMs](https://arxiv.org/abs/2505.10838)
*Ran Li,Hao Wang,Chengzhi Mao*

Main category: cs.LG

TL;DR: LARGO introduces a gradient-based latent space attack for jailbreaking LLMs, outperforming existing methods by 44 points in success rate.


<details>
  <summary>Details</summary>
Motivation: Existing gradient-based methods struggle in discrete language spaces, necessitating a novel approach to uncover LLM vulnerabilities.

Method: LARGO optimizes adversarial latent vectors in the LLM's continuous space and decodes them into natural language prompts.

Result: LARGO achieves a 44-point higher attack success rate than leading methods like AutoDAN on benchmarks.

Conclusion: LARGO demonstrates the efficacy of gradient optimization for attacking LLM internals, offering a potent alternative to agentic prompting.
...
### [305] [Maximizing Asynchronicity in Event-based Neural Networks](https://arxiv.org/abs/2505.11165)
*Haiqing Hao,Nikola Zubić,Weihua He,Zhipeng Sui,Davide Scaramuzza,Wenhui Wang*

Main category: cs.LG

TL;DR: EVA (EVent Asynchronous representation learning) is a novel A2S framework that improves expressivity and generalizability for event-based vision tasks, outperforming prior methods.


<details>
  <summary>Details</summary>
Motivation: Event cameras' sparse, asynchronous data challenges standard ML methods, and existing A2S approaches lack expressivity and generalizability.

Method: EVA adapts language modeling techniques (linear attention and self-supervised learning) to create event-by-event representations.

Result: EVA excels in recognition tasks (DVS128-Gesture, N-Cars) and achieves 47.7 mAP on Gen1 detection, surpassing prior A2S methods.
...
### [306] [Visual Planning: Let's Think Only with Images](https://arxiv.org/abs/2505.11409)
*Yi Xu,Chengzu Li,Han Zhou,Xingchen Wan,Caiqi Zhang,Anna Korhonen,Ivan Vulić*

Main category: cs.LG

TL;DR: The paper introduces Visual Planning, a method for reasoning via visual representations instead of text, and presents VPRL, a reinforcement learning framework that improves planning in visual tasks.


<details>
  <summary>Details</summary>
Motivation: Language may not be the most effective modality for reasoning, especially in spatial or geometrical tasks.

Method: Proposes Visual Planning, a paradigm using sequences of images for reasoning, and introduces VPRL, a reinforcement learning framework with GRPO for post-training vision models.

Result: VPRL outperforms text-only reasoning in visual navigation tasks like FrozenLake, Maze, and MiniBehavior.
...
### [307] [A probabilistic framework for dynamic quantization](https://arxiv.org/abs/2505.10689)
*Gabriele Santini,Francesco Paissan,Elisabetta Farella*
...
<details>
  <summary>Details</summary>
Motivation: To improve the efficiency of neural network quantization by dynamically adjusting parameters per input without significant memory or performance costs.

Method: Uses a probabilistic model on pre-activations via a lightweight surrogate for adaptive quantization parameter adjustment.

Result: Validated on computer vision tasks, showing negligible performance loss and superior tradeoff between performance and computational overhead.

Conclusion: The method outperforms standard quantization strategies in balancing performance and computational efficiency.
...
### [308] [Hashing for Structure-based Anomaly Detection](https://arxiv.org/abs/2505.10873)
*Filippo Leveni,Luca Magri,Cesare Alippi,Giacomo Boracchi*
...
<details>
  <summary>Details</summary>
Motivation: To detect anomalies in datasets by leveraging structured patterns and avoiding high computational costs of explicit distance calculations.

Method: Uses Locality Sensitive Hashing (LSH) to embed data in a Preference Space, identifying anomalies as isolated points without explicit distance computations.

Result: Achieves state-of-the-art performance with lower computational cost compared to traditional methods.

Conclusion: The proposed method is efficient and effective for anomaly detection in structured datasets, with publicly available code for implementation.
...
### [309] [MultiLink: Multi-class Structure Recovery via Agglomerative Clustering and Model Selection](https://arxiv.org/abs/2505.10874)
*Luca Magri,Filippo Leveni,Giacomo Boracchi*

Main category: cs.LG

TL;DR: MultiLink algorithm for robust fitting of multiple geometric structures in noisy datasets, outperforming state-of-the-art methods.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of recovering diverse geometric structures (e.g., planes, cylinders) in noisy datasets with outliers.

Method: MultiLink combines on-the-fly model fitting and selection via a novel linkage scheme for clustering.

Result: Faster, less sensitive to inlier thresholds, and compensates for sampling limitations, outperforming alternatives.

Conclusion: MultiLink is effective for multi-class and single-class problems, with publicly available code.
...
### [310] [Preference Isolation Forest for Structure-based Anomaly Detection](https://arxiv.org/abs/2505.10876)
*Filippo Leveni,Luca Magri,Cesare Alippi,Giacomo Boracchi*

Main category: cs.LG

TL;DR: The paper introduces Preference Isolation Forest (PIF), a framework for anomaly detection by embedding data into a preference space and identifying anomalies as isolated points. It proposes three isolation methods: Voronoi-iForest, RuzHash-iForest, and Sliding-PIF.


<details>
  <summary>Details</summary>
Motivation: The problem addressed is detecting anomalies that deviate from structured patterns represented by low-dimensional manifolds.

Method: PIF combines adaptive isolation-based methods with preference embedding. Data is embedded into a high-dimensional preference space, and anomalies are identified as isolated points using three approaches: Voronoi-iForest, RuzHash-iForest, and Sliding-PIF.

Result: The framework provides a flexible and efficient way to detect anomalies by leveraging low-dimensional manifolds and isolation techniques.

Conclusion: PIF offers a novel and effective solution for anomaly detection, with three tailored isolation methods for varying scenarios.
...
### [311] [CTP: A hybrid CNN-Transformer-PINN model for ocean front forecasting](https://arxiv.org/abs/2505.10894)
*Yishuo Wang,Feng Zhou,Muping Zhou,Qicheng Meng,Zhijun Hu,Yi Wang*
...
<details>
  <summary>Details</summary>
Motivation: Existing methods like LSTM and ConvLSTM struggle with spatial continuity and physical consistency in multi-step ocean front forecasts.

Method: CTP integrates CNN for spatial encoding, Transformer for temporal attention, and PINN for physical constraints.

Result: CTP achieves SOTA performance in single and multi-step predictions, excelling in accuracy, F1 score, and stability in SCS and KUR regions.
...
### [312] [Assessing the Performance of Analog Training for Transfer Learning](https://arxiv.org/abs/2505.11067)
*Omobayode Fagbohungbe,Corey Lammie,Malte J. Rasch,Takashi Ando,Tayfun Gokmen,Vijay Narayanan*

Main category: cs.LG

TL;DR: The paper introduces the c-TTv2 algorithm to address challenges in analog in-memory computing for deep learning, demonstrating its performance and robustness in analog transfer learning.


<details>
  <summary>Details</summary>
Motivation: Current training algorithms fail to achieve good outcomes in analog in-memory computing due to device asymmetries and variations. The c-TTv2 algorithm is proposed to overcome these limitations.

Method: The c-TTv2 algorithm is evaluated using a Swin-ViT model on a CIFAR100 subset, testing robustness against device specifications like noise and variability.

Result: The c-TTv2 algorithm shows promising performance and robustness in analog transfer learning, addressing key challenges of device behavior.

Conclusion: The c-TTv2 algorithm is a viable solution for analog in-memory computing, enabling efficient deep learning training despite device imperfections.
...
### [313] [What's Inside Your Diffusion Model? A Score-Based Riemannian Metric to Explore the Data Manifold](https://arxiv.org/abs/2505.11128)
*Simone Azeglio,Arianna Di Bernardo*

Main category: cs.LG

TL;DR: The paper introduces a score-based Riemannian metric to analyze the geometric properties of data manifolds learned by diffusion models, improving interpolation and extrapolation tasks.
...
Method: Proposes a score-based Riemannian metric using the Stein score function to define a metric tensor that respects the manifold's intrinsic geometry. Efficient algorithms compute geodesics for interpolation and extrapolation.

Result: The method outperforms baselines on perceptual and distribution-level metrics (LPIPS, FID, KID), producing smoother, more realistic image transitions.

Conclusion: The work reveals the implicit geometric structure in diffusion models and offers a principled way to navigate natural image manifolds using Riemannian geometry.
...
### [314] [Towards Robust Spiking Neural Networks:Mitigating Heterogeneous Training Vulnerability via Dominant Eigencomponent Projection](https://arxiv.org/abs/2505.11134)
*Desong Zhang,Jia Hu,Geyong Min*
...
<details>
  <summary>Details</summary>
Motivation: The vulnerability of SNNs to data distribution shifts when trained with direct encoding and BPTT poses a risk for reliable deployment.

Method: Developed Dominant Eigencomponent Projection (DEP) to orthogonally project gradients, reducing the Hessian spectral radius and preventing sharp minima.

Result: DEP effectively mitigates vulnerability to heterogeneous data poisoning and enhances overall robustness compared to baselines.

Conclusion: DEP provides a safer and more reliable method for SNN deployment by addressing the inherent vulnerabilities of direct encoding and BPTT.
...
### [315] [REI-Bench: Can Embodied Agents Understand Vague Human Instructions in Task Planning?](https://arxiv.org/abs/2505.10872)
...
### [316] [TartanGround: A Large-Scale Dataset for Ground Robot Perception and Navigation](https://arxiv.org/abs/2505.10696)
...
### [317] [GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats](https://arxiv.org/abs/2505.10923)
...
### [318] [DexGarmentLab: Dexterous Garment Manipulation Environment with Generalizable Policy](https://arxiv.org/abs/2505.11032)
...
### [319] [Planar Velocity Estimation for Fast-Moving Mobile Robots Using Event-Based Optical Flow](https://arxiv.org/abs/2505.11116)
...
### [320] [Open-Source Multi-Viewpoint Surgical Telerobotics](https://arxiv.org/abs/2505.11142)
...
### [321] [Exploiting Radiance Fields for Grasp Generation on Novel Synthetic Views](https://arxiv.org/abs/2505.11467)
...
### [322] [REI-Bench: Can Embodied Agents Understand Vague Human Instructions in Task Planning?](https://arxiv.org/abs/2505.10872)
*Chenxi Jiang,Chuhao Zhou,Jianfei Yang*

Main category: cs.RO

TL;DR: The paper addresses vagueness in human instructions for robot task planning, proposes a benchmark (REI-Bench), and introduces a method to improve performance.


<details>
  <summary>Details</summary>
Motivation: Real-world users, especially the elderly and children, often give vague instructions, which degrade robot task planning performance.

Method: Proposes task-oriented context cognition to clarify vague referring expressions (REs) in instructions.

Result: Vague REs reduce success rates by up to 77.9%; the proposed method outperforms existing approaches.

Conclusion: The work enhances robot task planning for non-expert users, advancing human-robot interaction.
...
### [323] [TartanGround: A Large-Scale Dataset for Ground Robot Perception and Navigation](https://arxiv.org/abs/2505.10696)
*Manthan Patel,Fan Yang,Yuheng Qiu,Cesar Cadena,Sebastian Scherer,Marco Hutter,Wenshan Wang*

Main category: cs.RO

TL;DR: TartanGround is a large-scale, multi-modal dataset for ground robots, featuring diverse data types and environments to improve robotic perception and autonomy.


<details>
  <summary>Details</summary>
Motivation: To address the lack of datasets that generalize across diverse scenes for robotic tasks like SLAM and occupancy prediction.

Method: Data is collected using an integrated automatic pipeline in simulation, mimicking various ground robot motions, with 910 trajectories across 70 environments.

Result: State-of-the-art methods trained on existing datasets struggle with generalization, while TartanGround provides a robust testbed for diverse tasks.

Conclusion: TartanGround enables advancements in robotic perception and autonomy, with the dataset and codebase to be publicly released.
...
### [324] [GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats](https://arxiv.org/abs/2505.10923)
*Simeon Adebola,Shuangyu Xie,Chung Min Kim,Justin Kerr,Bart M. van Marrewijk,Mieke van Vlaardingen,Tim van Daalen,Robert van Loo,Jose Luis Susa Rincon,Eugen Solowjow,Rick van de Zedde,Ken Goldberg*
...
Method: Combines 3D Gaussian Splatting with a two-stage registration (coarse feature-based matching and fine Iterative Closest Point).

Result: Produces consistent 4D models of plant development, evaluated on Sequoia and Quinoa species.
...
### [325] [DexGarmentLab: Dexterous Garment Manipulation Environment with Generalizable Policy](https://arxiv.org/abs/2505.11032)
*Yuran Wang,Ruihai Wu,Yue Chen,Jiarui Wang,Jiaqi Liang,Ziyu Zhu,Haoran Geng,Jitendra Malik,Pieter Abbeel,Hao Dong*

Main category: cs.RO

TL;DR: DexGarmentLab introduces a simulation environment for dexterous garment manipulation, leveraging garment structural correspondence for dataset generation and proposing HALO for improved generalization.


<details>
  <summary>Details</summary>
Motivation: Existing research struggles to replicate human dexterity in garment manipulation due to unrealistic simulations and labor-intensive data collection methods.

Method: Proposes DexGarmentLab with high-quality 3D assets and refined simulation techniques. Introduces HALO, a hierarchical policy for transferable affordance points and generalizable trajectories.

Result: HALO outperforms baselines, generalizing to unseen garment shapes and deformations.

Conclusion: DexGarmentLab and HALO advance dexterous garment manipulation, reducing manual effort and improving generalization.
...
### [326] [Planar Velocity Estimation for Fast-Moving Mobile Robots Using Event-Based Optical Flow](https://arxiv.org/abs/2505.11116)
*Liam Boyle,Jonas Kühne,Nicolas Baumann,Niklas Bastuck,Michele Magno*

Main category: cs.RO

TL;DR: The paper introduces a velocity estimation method for mobile robotics using event cameras and planar kinematics, avoiding wheel-to-surface traction assumptions. It shows improved performance over existing methods.


<details>
  <summary>Details</summary>
Motivation: Accurate velocity estimation is crucial for autonomous driving, but current methods rely on assumptions or complex models that fail in varying conditions.

Method: The approach combines planar kinematics with optical flow from event cameras pointed at the ground, leveraging their low latency and high dynamic range.
...
### [327] [Open-Source Multi-Viewpoint Surgical Telerobotics](https://arxiv.org/abs/2505.11142)
*Guido Caccianiga,Yarden Sharon,Bernard Javot,Senya Polikovsky,Gökce Ergün,Ivan Capobianco,André L. Mihaljevic,Anton Deguet,Katherine J. Kuchenbecker*

Main category: cs.RO

TL;DR: The paper proposes expanding surgical teleoperation by introducing adjustable viewpoints in MIS to enhance visualization, collaboration, and machine perception for shared autonomy.


<details>
  <summary>Details</summary>
Motivation: To rethink and improve surgical teleoperation by leveraging additional viewpoints and advanced 3D perception for better collaboration and robustness.

Method: Building a synchronized multi-viewpoint, multi-sensor robotic surgery system using high-performance vision components and upgraded da Vinci Research Kit control logic.

Result: A functional setup is reported, highlighting potential impacts on research and clinical practice, with plans to open-source the system.

Conclusion: The system aims to boost clinical translation of advanced research by enabling community collaboration and algorithm development.
...
### [328] [Exploiting Radiance Fields for Grasp Generation on Novel Synthetic Views](https://arxiv.org/abs/2505.11467)
*Abhishek Kashyap,Henrik Andreasson,Todor Stoyanov*
...
<details>
  <summary>Details</summary>
Motivation: Multiple real camera views for object manipulation are time-consuming and constrained by reachability, while novel view synthesis can provide extra context efficiently.

Method: Leveraging scene representations like Gaussian Splatting to synthesize virtual images from novel viewpoints for grasp pose generation.

Result: Experiments on Graspnet-1billion show novel views add force-closure grasps and improve grasp coverage compared to sparse real views.

Conclusion: Novel view synthesis enhances grasp extraction; future work aims to extend this to single-image radiance fields using diffusion models or generalizable radiance fields.
...
### [329] [GRNN:Recurrent Neural Network based on Ghost Features for Video Super-Resolution](https://arxiv.org/abs/2505.10577)
*Yutong Guo*
...
### [330] [ExploreGS: a vision-based low overhead framework for 3D scene reconstruction](https://arxiv.org/abs/2505.10578)
...
### [331] [MOSAIC: A Multi-View 2.5D Organ Slice Selector with Cross-Attentional Reasoning for Anatomically-Aware CT Localization in Medical Organ Segmentation](https://arxiv.org/abs/2505.10672)
...
### [332] [ROIsGAN: A Region Guided Generative Adversarial Framework for Murine Hippocampal Subregion Segmentation](https://arxiv.org/abs/2505.10687)
...
### [333] [Predicting Risk of Pulmonary Fibrosis Formation in PASC Patients](https://arxiv.org/abs/2505.10691)
...
### [334] [Adaptive Spatial Transcriptomics Interpolation via Cross-modal Cross-slice Modeling](https://arxiv.org/abs/2505.10729)
...
### [335] [Pretrained hybrid transformer for generalizable cardiac substructures segmentation from contrast and non-contrast CTs in lung and breast cancers](https://arxiv.org/abs/2505.10855)
...
### [336] [Generative Models in Computational Pathology: A Comprehensive Survey on Methods, Applications, and Challenges](https://arxiv.org/abs/2505.10993)
...
### [337] [Diffusion Model in Hyperspectral Image Processing and Analysis: A Review](https://arxiv.org/abs/2505.11158)
...
### [338] [From Fibers to Cells: Fourier-Based Registration Enables Virtual Cresyl Violet Staining From 3D Polarized Light Imaging](https://arxiv.org/abs/2505.11394)
...
### [339] [GRNN:Recurrent Neural Network based on Ghost Features for Video Super-Resolution](https://arxiv.org/abs/2505.10577)
*Yutong Guo*

Main category: eess.IV

TL;DR: The paper proposes using 'Ghost features' to reduce redundancy in VSR models and combines it with RNN to address gradient disappearance, improving PSNR and SSIM while preserving texture details.


<details>
  <summary>Details</summary>
Motivation: Feature redundancy in VSR models and gradient disappearance in RNNs are identified as key issues to address for better performance.

Method: Introduces 'Ghost features' to reduce redundancy and combines them with RNN for temporal modeling, using current and next frames, previous output, and hidden state as inputs.

Result: Experiments show improved PSNR and SSIM, with better preservation of texture details in videos.

Conclusion: The proposed method effectively reduces redundancy and addresses gradient issues, enhancing VSR performance.
...
### [340] [ExploreGS: a vision-based low overhead framework for 3D scene reconstruction](https://arxiv.org/abs/2505.10578)
*Yunji Feng,Chengpu Yu,Fengrui Ran,Zhi Yang,Yinni Liu*
...
<details>
  <summary>Details</summary>
Motivation: To provide a low-cost, efficient alternative to lidar-based 3D reconstruction for drones, leveraging vision-based methods for resource-constrained devices.

Method: Uses RGB images and a BoW model for real-time processing, integrating scene exploration and reconstruction to enable on-board 3DGS training.

Result: Achieves high-quality reconstructions comparable to state-of-the-art methods, with demonstrated efficiency in simulations and real-world environments.

Conclusion: ExploreGS is a viable, cost-effective solution for 3D scene reconstruction on drones, balancing performance and resource constraints.
...
### [341] [MOSAIC: A Multi-View 2.5D Organ Slice Selector with Cross-Attentional Reasoning for Anatomically-Aware CT Localization in Medical Organ Segmentation](https://arxiv.org/abs/2505.10672)
*Hania Ghouse,Muzammil Behzad*

Main category: eess.IV

TL;DR: A novel anatomically-aware slice selector pipeline is proposed to efficiently filter CT volumes for multi-organ segmentation, using a vision-language model for cross-view organ detection and introducing a new metric, Slice Localization Concordance (SLC), for evaluation.


<details>
  <summary>Details</summary>
Motivation: Existing 3D segmentation methods are computationally intensive, while 2D methods lack contextual awareness and suffer from class imbalance. The goal is to reduce input volume size without losing anatomical relevance.

Method: A vision-language model (VLM) is used for cross-view organ presence detection with fused tri-slice (2.5D) representations from axial, sagittal, and coronal planes. The model selectively retains slices with high structural relevance.

Result: The proposed method outperforms baselines across all organs, achieving efficient and spatially consistent organ filtering while maintaining high anatomical fidelity.

Conclusion: The pipeline significantly reduces segmentation cost and computational load while preserving accuracy, validated by the novel SLC metric.
...
### [342] [ROIsGAN: A Region Guided Generative Adversarial Framework for Murine Hippocampal Subregion Segmentation](https://arxiv.org/abs/2505.10687)
*Sayed Mehedi Azim,Brian Corbett,Iman Dehzangi*
...
<details>
  <summary>Details</summary>
Motivation: Accurate segmentation of hippocampal subregions (DG, CA1, CA3) from histological images is crucial for understanding diseases and therapies, but no automated methods exist for IHC images.
...
Result: ROIsGAN outperforms conventional models, achieving 1-10% higher Dice scores and up to 11% better IoU, especially under challenging staining conditions.
...
### [343] [Predicting Risk of Pulmonary Fibrosis Formation in PASC Patients](https://arxiv.org/abs/2505.10691)
*Wanying Dou,Gorkem Durak,Koushik Biswas,Ziliang Hong,Andrea Mia Bejar,Elif Keles,Kaan Akin,Sukru Mehmet Erturk,Alpay Medetalibeyoglu,Marc Sala,Alexander Misharin,Hatice Savas,Mary Salvatore,Sachin Jambawalikar,Drew Torigian,Jayaram K. Udupa,Ulas Bagci*

Main category: eess.IV

TL;DR: The paper introduces a deep learning and radiomics-based framework for predicting lung fibrosis in Long COVID patients using chest CT scans, achieving high accuracy and AUC.


<details>
  <summary>Details</summary>
Motivation: Addressing the uncertainty and challenges in diagnosing and managing Post-Acute Sequelae of COVID-19 (PASC), particularly lung fibrosis, due to its heterogeneous symptoms.

Method: A multi-center chest CT analysis framework combining convolutional neural networks (CNNs) and radiomics for fibrosis prediction, with Grad-CAM visualization for interpretability.

Result: Achieved 82.2% accuracy and 85.5% AUC in classification tasks, demonstrating the framework's effectiveness for early detection and risk assessment.

Conclusion: The study highlights the potential of deep learning-driven methods for improving clinical insights and management of PASC-related lung fibrosis.
...
### [344] [Adaptive Spatial Transcriptomics Interpolation via Cross-modal Cross-slice Modeling](https://arxiv.org/abs/2505.10729)
*NingFeng Que,Xiaofei Wang,Jingjing Chen,Yixuan Jiang,Chao Li*

Main category: eess.IV

TL;DR: C2-STi is a novel method for interpolating missing spatial transcriptomics (ST) slices, addressing challenges like tissue heterogeneity, gene correlations, and cellular structures.


<details>
  <summary>Details</summary>
Motivation: The high cost and missing intermediate sections in multi-slice ST analysis limit practical feasibility, prompting the need for interpolation.

Method: C2-STi uses distance-aware local structural modulation, pyramid gene co-expression correlation, and cross-modal alignment with H&E images.

Result: Outperforms state-of-the-art methods in single-slice and multi-slice ST interpolation.

Conclusion: C2-STi effectively interpolates missing ST slices, enhancing spatial transcriptomics analysis.
...
### [345] [Pretrained hybrid transformer for generalizable cardiac substructures segmentation from contrast and non-contrast CTs in lung and breast cancers](https://arxiv.org/abs/2505.10855)
*Aneesh Rangnekar,Nikhil Mankuzhy,Jonas Willmann,Chloe Choi,Abraham Wu,Maria Thor,Andreas Rimner,Harini Veeraraghavan*
...
<details>
  <summary>Details</summary>
Motivation: AI segmentations for radiation treatment planning often fail in clinical cases differing from training data. This study aims to improve robustness for varying imaging contrasts and patient positions.

Method: The HTN model was trained on a balanced dataset of contrast-enhanced and non-contrast CT scans (CECT and NCCT) and evaluated on validation sets with diverse patient characteristics.

Result: The balanced HTN model matched oracle performance with half the training data, outperformed TotalSegmentator, and showed robustness to contrast and scan position variations.

Conclusion: The HTN model provides clinically viable, accurate segmentations under varied conditions, reducing the need for extensive labeled datasets.
...
### [346] [Generative Models in Computational Pathology: A Comprehensive Survey on Methods, Applications, and Challenges](https://arxiv.org/abs/2505.10993)
*Yuan Zhang,Xinfeng Zhang,Xiaoming Qi Xinyu Wu,Feng Chen,Guanyu Yang,Huazhu Fu*

Main category: eess.IV

TL;DR: A review of generative modeling in computational pathology, covering image/text/multimodal generation, evolution of architectures, datasets, limitations, and future directions.


<details>
  <summary>Details</summary>
Motivation: To synthesize recent progress and challenges in generative modeling for computational pathology, aiding researchers and practitioners.

Method: Analysis of over 150 studies, focusing on generative architectures (GANs, diffusion models, foundation models), datasets, and evaluation protocols.

Result: Identifies key domains (image, text, multimodal generation) and limitations (fidelity, interpretability, ethical concerns).

Conclusion: Highlights open challenges and future directions for unified, multimodal, clinically deployable generative systems.
...
### [347] [Diffusion Model in Hyperspectral Image Processing and Analysis: A Review](https://arxiv.org/abs/2505.11158)
*Xing Hu,Xiangcheng Liu,Qianqian Duan,Danfeng Hong,Dawei Zhang*

Main category: eess.IV

TL;DR: The paper reviews the use of Diffusion Models in hyperspectral image processing, highlighting their advantages over traditional methods in handling high-dimensional data, noise, and redundancy.


<details>
  <summary>Details</summary>
Motivation: Hyperspectral image analysis faces challenges like high dimensionality and noise, which traditional models struggle with. Diffusion Models offer a promising solution.

Method: The paper reviews recent research on Diffusion Models, focusing on their application in hyperspectral image tasks like denoising, classification, and anomaly detection.

Result: Diffusion Models improve accuracy and efficiency in hyperspectral image analysis, outperforming traditional methods.

Conclusion: Diffusion Models provide a new research direction for hyperspectral image processing, though challenges remain.
...
### [348] [From Fibers to Cells: Fourier-Based Registration Enables Virtual Cresyl Violet Staining From 3D Polarized Light Imaging](https://arxiv.org/abs/2505.11394)
*Alexander Oberstrass,Esteban Vaca,Eric Upschulte,Meiqi Niu,Nicola Palomero-Gallagher,David Graessel,Christian Schiffer,Markus Axer,Katrin Amunts,Timo Dickscheid*

Main category: eess.IV

TL;DR: The paper proposes a deep learning method to generate virtual Cresyl violet staining from 3D-PLI images, enabling aligned cyto- and myeloarchitectonic analysis without physical post-staining.


<details>
  <summary>Details</summary>
Motivation: To overcome distortions and limited samples in post-staining histological sections, the study aims to link fiber and cell architectures non-invasively.
...
Result: Successfully predicts Cresyl violet staining from 3D-PLI, matching individual cell instances.

Conclusion: The method provides a virtual, aligned alternative to physical staining, enhancing microstructure analysis.
...
### [349] [Textured mesh Quality Assessment using Geometry and Color Field Similarity](https://arxiv.org/abs/2505.10824)
...
### [350] [Textured mesh Quality Assessment using Geometry and Color Field Similarity](https://arxiv.org/abs/2505.10824)
*Kaifa Yang,Qi Yang,Zhu Li,Yiling Xu*

Main category: cs.GR

TL;DR: A novel point-based TMQA method, FMQM, uses signed distance and color fields for accurate and robust mesh quality assessment, outperforming SOTA methods with low computational complexity.
...
Method: FMQM employs signed distance fields and a new color field (nearest surface point color field) to extract four visual perception features: geometry similarity, geometry gradient similarity, space color distribution similarity, and space color gradient similarity.

Result: FMQM outperforms SOTA TMQA metrics on three benchmark datasets and has low computational complexity.

Conclusion: FMQM is a practical, efficient solution for real-world 3D graphics and visualization applications, with publicly available code.
...
### [351] [MatTools: Benchmarking Large Language Models for Materials Science Tools](https://arxiv.org/abs/2505.10852)
...
### [352] [MatTools: Benchmarking Large Language Models for Materials Science Tools](https://arxiv.org/abs/2505.10852)
*Siyu Liu,Jiamin Xu,Beilin Ye,Bo Hu,David J. Srolovitz,Tongqi Wen*

Main category: cond-mat.mtrl-sci

TL;DR: The paper introduces MatTools, a benchmark to evaluate LLMs in materials science by generating and executing code for physics-based simulations. It includes a QA benchmark (69,225 pairs) and a real-world tool-usage benchmark (49 tasks). Key findings highlight generalist LLMs outperform specialists, AI models understand AI tools better, and simplicity is advantageous.


<details>
  <summary>Details</summary>
Motivation: To assess and improve LLM capabilities in materials science, bridging the gap between AI and physics-based computational tools.

Method: Developed MatTools with two benchmarks: a QA benchmark from pymatgen and a real-world tool-usage benchmark. Automated methodology collected real-world examples.

Result: Generalist LLMs outperformed specialists; AI models excelled with AI tools; simpler approaches were more effective.

Conclusion: MatTools offers a standardized framework to enhance LLM applications in materials science, aiding AI development for scientific research.
...
### [353] [Creating General User Models from Computer Use](https://arxiv.org/abs/2505.10831)
...
### [354] [Large Language Model Use Impact Locus of Control](https://arxiv.org/abs/2505.11406)
...
### [355] [Creating General User Models from Computer Use](https://arxiv.org/abs/2505.10831)
*Omar Shaikh,Shardul Sapkota,Shan Rizvi,Eric Horvitz,Joon Sung Park,Diyi Yang,Michael S. Bernstein*
...
<details>
  <summary>Details</summary>
Motivation: Current user models are fragmented and lack flexibility. The paper aims to create a unified model that understands users deeply from diverse interactions.

Method: GUM processes unstructured observations (e.g., screenshots) to construct confidence-weighted propositions about users. It infers, retrieves, and revises these propositions continuously.
...
### [356] [Large Language Model Use Impact Locus of Control](https://arxiv.org/abs/2505.11406)
*Jenny Xiyu Fu,Brennan Antone,Kowe Kadoma,Malte Jung*

Main category: cs.HC

TL;DR: The paper examines how co-writing with AI affects people's locus of control, finding employment status influences reliance on AI and perceived agency.
...
Method: An empirical study with 462 participants, analyzing quantitative data and qualitative observations.

Result: Employed participants showed higher AI reliance and internal control, while unemployed users felt reduced personal agency.

Conclusion: The study highlights AI's role in shaping personal agency and identity, prompting further discussion.
...
### [357] [On Next-Token Prediction in LLMs: How End Goals Determine the Consistency of Decoding Algorithms](https://arxiv.org/abs/2505.11183)
...
### [358] [A Fourier Space Perspective on Diffusion Models](https://arxiv.org/abs/2505.11278)
...
### [359] [On Next-Token Prediction in LLMs: How End Goals Determine the Consistency of Decoding Algorithms](https://arxiv.org/abs/2505.11183)
*Jacob Trauger,Ambuj Tewari*

Main category: stat.ML

TL;DR: The paper analyzes consistency of next-token prediction algorithms (greedy, lookahead, random sampling, temperature-scaled sampling) with respect to various loss functions in LLMs, revealing trade-offs between goals like information retrieval and creative generation.


<details>
  <summary>Details</summary>
Motivation: To study the theoretical grounding of decoding algorithms in LLMs and their alignment with different goals (e.g., mimicking true distributions or minimizing sequence-level loss).

Method: Examines consistency of surrogate losses for next-token prediction algorithms, comparing their performance under different probability distributions and goals.

Result: Random sampling is consistent with mimicking true distributions, while other algorithms are only optimal for specific distributions. No polynomial-time algorithm is universally optimal for all goals.

Conclusion: Choosing the right decoding algorithm is crucial, as current methods lack theoretical grounding for many scenarios, highlighting a trade-off between information retrieval and creative generation.
...
### [360] [A Fourier Space Perspective on Diffusion Models](https://arxiv.org/abs/2505.11278)
*Fabian Falck,Teodora Pandeva,Kiarash Zahirnia,Rachel Lawrence,Richard Turner,Edward Meeds,Javier Zazo,Sushrut Karmalkar*

Main category: stat.ML

TL;DR: The paper analyzes the inductive bias of diffusion models in Fourier space, showing that standard DDPM corrupts high frequencies faster, degrading their generation quality. An alternative forward process equalizing noise rates across frequencies improves performance, especially for high-frequency data.


<details>
  <summary>Details</summary>
Motivation: To understand and address the frequency-dependent corruption in diffusion models, which affects generation quality, particularly for high-frequency components.

Method: Theoretical analysis and empirical demonstration of DDPM's frequency bias, followed by proposing and testing an alternative forward process in Fourier space that equalizes noise rates.

Result: The standard DDPM violates normality assumptions for high frequencies, degrading their generation. The alternative process improves performance for high-frequency data while matching DDPM on standard benchmarks.

Conclusion: Equalizing noise rates across frequencies in the forward process can enhance diffusion model performance, especially for datasets where high frequencies are critical.
...
### [361] [MPMA: Preference Manipulation Attack Against Model Context Protocol](https://arxiv.org/abs/2505.11154)
...
### [362] [MPMA: Preference Manipulation Attack Against Model Context Protocol](https://arxiv.org/abs/2505.11154)
*Zihan Wang,Hongwei Li,Rui Zhang,Yu Liu,Wenbo Jiang,Wenshu Fan,Qingchuan Zhao,Guowen Xu*

Main category: cs.CR

TL;DR: The paper introduces MCP Preference Manipulation Attack (MPMA), a security threat in the Model Context Protocol (MCP) ecosystem, and proposes two attack methods (DPMA and GAPMA) to exploit it, emphasizing the need for defenses.


<details>
  <summary>Details</summary>
Motivation: The increasing adoption of MCP exposes security vulnerabilities, particularly through third-party customized servers, leading to potential economic exploitation.

Method: Two attack methods are proposed: Direct Preference Manipulation Attack (DPMA) and Genetic-based Advertising Preference Manipulation Attack (GAPMA), the latter using Genetic Algorithms for stealth.

Result: GAPMA balances effectiveness and stealthiness, demonstrating the vulnerability of MCP in open ecosystems.

Conclusion: The study highlights the urgent need for robust defense mechanisms to ensure fairness in the MCP ecosystem.
...
### [363] [$\mathcal{A}LLM4ADD$: Unlocking the Capabilities of Audio Large Language Models for Audio Deepfake Detection](https://arxiv.org/abs/2505.11079)
...
### [364] [Audio Turing Test: Benchmarking the Human-likeness of Large Language Model-based Text-to-Speech Systems in Chinese](https://arxiv.org/abs/2505.11200)
...
### [366] [$\mathcal{A}LLM4ADD$: Unlocking the Capabilities of Audio Large Language Models for Audio Deepfake Detection](https://arxiv.org/abs/2505.11079)
*Hao Gu,Jiangyan Yi,Chenglong Wang,Jianhua Tao,Zheng Lian,Jiayi He,Yong Ren,Yujie Chen,Zhengqi Wen*

Main category: cs.SD

TL;DR: The paper explores using Audio Large Language Models (ALLMs) for Audio Deepfake Detection (ADD), finding them ineffective in zero-shot settings but proposing a fine-tuned framework, ALLM4ADD, which improves performance, especially in data-scarce scenarios.


<details>
  <summary>Details</summary>
Motivation: The rise of high-fidelity audio generative models and their misuse potential necessitates effective ADD solutions. ALLMs' success in audio tasks prompts investigation into their utility for ADD.

Method: The authors reformulate ADD as an audio question-answering task, fine-tuning ALLMs with the question "Is this audio fake or real?" to assess authenticity.

Result: ALLM4ADD outperforms zero-shot ALLMs in detecting fake audio, particularly in data-scarce conditions.

Conclusion: This work pioneers ALLM use for ADD, encouraging further research into leveraging ALLMs for more effective detection systems.
...
### [367] [Audio Turing Test: Benchmarking the Human-likeness of Large Language Model-based Text-to-Speech Systems in Chinese](https://arxiv.org/abs/2505.11200)
*Xihuai Wang,Ziyi Zhao,Siyu Ren,Shao Zhang,Song Li,Xiaoyu Li,Ziwen Wang,Lin Qiu,Guanglu Wan,Xuezhi Cao,Xunliang Cai,Weinan Zhang*
...
Method: The authors propose ATT, a Turing-Test-inspired protocol where evaluators judge if a voice sounds human. They also finetune Qwen2-Audio-Instruct (Auto-ATT) for automatic evaluation.

Result: ATT effectively differentiates TTS models across dimensions, and Auto-ATT aligns well with human evaluations, proving its reliability.

Conclusion: ATT and Auto-ATT offer robust, simplified evaluation tools for TTS systems, with ATT-Corpus and Auto-ATT publicly available.
...
### [368] [Seeing Sound, Hearing Sight: Uncovering Modality Bias and Conflict of AI models in Sound Localization](https://arxiv.org/abs/2505.11217)
*Yanhao Jia,Ji Xie,S Jivaganesh,Hao Li,Xu Wu,Mengmi Zhang*

Main category: cs.SD

TL;DR: The study explores how AI and humans handle cross-modal conflicts in sound localization, revealing AI's bias toward visuals and proposing a refined model that mimics human-like performance.


<details>
  <summary>Details</summary>
Motivation: To understand modality bias and conflict resolution in AI sound localization, comparing it to human performance.

Method: Assessed leading multimodal models against human performance in psychophysics experiments across six audiovisual conditions. Finetuned a state-of-the-art model using stereo audio-image data from 3D simulations.

Result: Humans outperformed AI, relying more on auditory cues. AI defaulted to visuals, degrading performance. The refined model improved accuracy and mirrored human-like left-right bias.

Conclusion: Sensory input quality and system architecture critically influence multimodal representation accuracy, with the refined model showing promise for better conflict resolution.
...
### [369] [Creativity or Brute Force? Using Brainteasers as a Window into the Problem-Solving Abilities of Large Language Models](https://arxiv.org/abs/2505.10844)
...
### [370] [Rethinking the Role of Prompting Strategies in LLM Test-Time Scaling: A Perspective of Probability Theory](https://arxiv.org/abs/2505.10981)
...
### [371] [SelfBudgeter: Adaptive Token Allocation for Efficient LLM Reasoning](https://arxiv.org/abs/2505.11274)
...
### [372] [Creativity or Brute Force? Using Brainteasers as a Window into the Problem-Solving Abilities of Large Language Models](https://arxiv.org/abs/2505.10844)
*Simeng Han,Stephen Xia,Grant Zhang,Howard Dai,Chen Liu,Lichang Chen,Hoang Huy Nguyen,Hongyuan Mei,Jiayuan Mao,R. Thomas McCoy*

Main category: cs.AI

TL;DR: The paper introduces a brainteaser-based benchmark to evaluate LLMs' reasoning strategies, focusing on solution quality and creativity, revealing both strengths and areas for improvement.


<details>
  <summary>Details</summary>
Motivation: To move beyond accuracy metrics and understand the reasoning strategies and creativity of LLMs in solving novel problems.

Method: A benchmark using narrative brainteasers to probe reasoning layers: semantic parsing, solution generation, self-correction, step-by-step sketches, and hint utilization.
...
Conclusion: LLMs show creative problem-solving potential but need refinement to reduce reliance on brute-force methods.
...
### [373] [Rethinking the Role of Prompting Strategies in LLM Test-Time Scaling: A Perspective of Probability Theory](https://arxiv.org/abs/2505.10981)
*Yexiang Liu,Zekun Li,Zhi Fang,Nan Xu,Ran He,Tieniu Tan*

Main category: cs.AI

TL;DR: The paper investigates how various reasoning prompting strategies scale with test-time compute in LLMs, focusing on majority voting. It finds that simpler strategies like Chain-of-Thought outperform complex ones as compute scales, and proposes a method to predict and enhance scaling performance.


<details>
  <summary>Details</summary>
Motivation: Limited research exists on how prompting strategies perform as test-time compute scales, especially in realistic settings like majority voting.

Method: Systematic experiments on 6 LLMs, 8 prompting strategies, and 6 benchmarks, analyzed with theoretical proofs and a probability-based prediction method.

Result: Complex prompting strategies initially outperform but fall behind simple Chain-of-Thought as compute scales. A method to predict scaling performance is proposed and validated.

Conclusion: The study advocates re-evaluating complex prompting, highlights the potential of simple strategies, and offers insights for improving test-time scaling.
...
### [374] [SelfBudgeter: Adaptive Token Allocation for Efficient LLM Reasoning](https://arxiv.org/abs/2505.11274)
*Zheng Li,Qingxiu Dong,Jingyuan Ma,Di Zhang,Zhifang Sui*

Main category: cs.AI

TL;DR: SelfBudgeter is a self-adaptive reasoning strategy that optimizes resource use by pre-estimating query difficulty and adjusting reasoning length, achieving significant compression without accuracy loss.


<details>
  <summary>Details</summary>
Motivation: Current reasoning models inefficiently process both simple and complex queries, wasting resources and increasing latency.

Method: Dual-phase training: cost pre-estimation and budget-guided GPRO for reinforcement learning to control reasoning length.

Result: Up to 74.47% response length compression on MATH benchmark with maintained accuracy.

Conclusion: SelfBudgeter efficiently allocates budgets, reduces latency, and allows user control over reasoning length.
...
### [375] [Towards Automated Situation Awareness: A RAG-Based Framework for Peacebuilding Reports](https://arxiv.org/abs/2505.10586)
...
### [376] [Understanding Gen Alpha Digital Language: Evaluation of LLM Safety Systems for Content Moderation](https://arxiv.org/abs/2505.10588)
...
### [377] [Phare: A Safety Probe for Large Language Models](https://arxiv.org/abs/2505.11365)
...
### [378] [Towards Automated Situation Awareness: A RAG-Based Framework for Peacebuilding Reports](https://arxiv.org/abs/2505.10586)
*Poli A. Nemkova,Suleyman O. Polat,Rafid I. Jahan,Sagnik Ray Choudhury,Sun-joo Lee,Shouryadipta Sarkar,Mark V. Albert*

Main category: cs.CY

TL;DR: A dynamic RAG system automates situation awareness reports by integrating real-time data, evaluated via a three-level framework for quality assurance.


<details>
  <summary>Details</summary>
Motivation: Manual analysis of vast data sources causes delays in humanitarian and conflict monitoring, necessitating an automated solution.

Method: The system uses Retrieval-Augmented Generation (RAG) to create query-specific knowledge bases and employs a three-level evaluation framework (NLP metrics, expert feedback, LLM-as-a-Judge).

Result: The system produces coherent, insightful, and actionable reports, tested in real-world scenarios.

Conclusion: Automating report generation reduces human burden and speeds up decision-making; code and tools are shared for reproducibility.
...
### [379] [Understanding Gen Alpha Digital Language: Evaluation of LLM Safety Systems for Content Moderation](https://arxiv.org/abs/2505.10588)
*Manisha Mehta,Fausto Giunchiglia*

Main category: cs.CY

TL;DR: The study evaluates AI models' ability to detect hidden risks in Gen Alpha's digital language, revealing gaps in current safety tools and proposing improvements.


<details>
  <summary>Details</summary>
Motivation: Gen Alpha's unique digital communication, shaped by gaming and AI trends, often hides harmful interactions, posing new online risks that current AI and human moderation fail to address.

Method: Four AI models (GPT-4, Claude, Gemini, Llama 3) were tested on a dataset of 100 Gen Alpha expressions from gaming, social media, and videos to assess their detection of masked harassment and manipulation.

Result: The study found significant comprehension failures in AI models, highlighting vulnerabilities in online safety for Gen Alpha and the need for better moderation tools.

Conclusion: The research underscores the urgency of redesigning safety systems to align with youth communication, involving Gen Alpha insights to address digital safety challenges.
...
### [380] [Phare: A Safety Probe for Large Language Models](https://arxiv.org/abs/2505.11365)
*Pierre Le Jeune,Benoît Malésieux,Weixuan Xiao,Matteo Dora*

Main category: cs.CY

TL;DR: Phare is a multilingual framework to evaluate LLM safety across hallucination, biases, and harmful content, revealing systematic vulnerabilities like sycophancy and stereotypes.


<details>
  <summary>Details</summary>
Motivation: Existing LLM evaluations focus on performance over safety; Phare aims to identify specific failure modes for responsible deployment.

Method: Phare probes 17 state-of-the-art LLMs across three safety dimensions: hallucination/reliability, social biases, and harmful content.

Result: The framework uncovers systematic vulnerabilities, including sycophancy, prompt sensitivity, and stereotype reproduction.

Conclusion: Phare offers actionable insights to improve LLM robustness and alignment, prioritizing safety over mere performance rankings.
